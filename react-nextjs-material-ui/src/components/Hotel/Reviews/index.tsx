  ...
  return (
    <>
      ...
      >
        ...
        <Box className="border" sx={{ borderRadius: "7px" }}>
          <TableContainer
            component={Paper}
            sx={{
              boxShadow: "none",
          ...
          >
            <Table sx={{ minWidth: 1250 }}>
              <TableHead className="bg-primary-50">
                ...
                >
                  <th className="text-black text-start">User ID</th>

                  <th className="text-black text-start">Customer Name</th>

                  <th className="text-black text-start">Ratings</th>

                  <th className="text-black text-start">Reviews</th>

                  <th className="text-black text-start">Date</th>

                  <th className="text-black text-end">Action</th>
                </TableRow>
              </TableHead>
