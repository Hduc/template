...
// Define the type for a follower
interface Follower {
  id: number;
  name: string;
  profileImage: string;
...
const recentInstagramFollowersData: Follower[] = [
  {
    id: 1,
    name: "Mason Lee",
...
const RecentInstagramFollowers: React.FC = () => {
  ...
  // Form
  const [visibleFormId, setVisibleFormId] = useState<number | null>(null);

  const toggleMessageForm = (userId: number) => {
