...
const TopSellingProduct = () => {
  ...
  const renderStars = (ratingStars: (boolean | "half")[]) => {
              ...
              >
                ...
                >
                  ...
                  <Box>
                    ...
                    <Box fontSize={"12px"}>
                      <Typography component={"span"} fontSize={"12px"} fontWeight={700}>
                        {product.sold}
                      </Typography>{" "}
                      sold
                    </Box>
                ...
                >
                  ...
                  <Typography sx={{ fontSize: "12px", position: "relative", top: "1px" }}>
                    {product.rating}
                  </Typography>
                </Box>
              </Box>
