	...
	(function () {
		...
		if (getTopSalesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#top_sales"),
				options
			);
			chart.render();
		}
		...
		if (getTotalOrders1Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#total_orders1"),
				options
			);
			chart.render();
		}
		...
		if (getTotalCustomersId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#total_customers"),
				options
			);
			chart.render();
		}
		...
		if (getTotalRevenueId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#total_evenue"),
				options
			);
			chart.render();
		}
		...
		if (getOrderSummeryId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#order_summery"),
				options
			);
			chart.render();
		}
		...
		const getReturningCustomerRateId = document.getElementById(
		...
		if (getReturningCustomerRateId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#returning_customer_rate"),
				options
			);
			chart.render();
		}
		...
		if (getRevenueGrowthId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#revenue_growth"),
				options
			);
			chart.render();
		}
		...
		if (getRevenueId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#revenue_ch"),
				options
			);
			chart.render();
		}
		...
		if (getLeadConversionId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#lead_conversion"),
				options
			);
			chart.render();
		}
		...
		if (getTotalOrder2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#total_orders2"),
				options
			);
			chart.render();
		}
		...
		if (getAnnualProfitId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#annual_profit"),
				options
			);
			chart.render();
		}
		...
		/* Balance Overview JS*/
		const getBalanceOverviewId =
			document.getElementById("balance_overview");
		...
		if (getLeadsBySourceId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#leads_by_source"),
				options
			);
			chart.render();
		}
		...
		/* Projects Roadmap JS */
		const getProjectsRoadmapId =
			document.getElementById("projects_roadmap");
		if (getProjectsRoadmapId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#projects_roadmap"),
				options
			);
			chart.render();
		}
		...
		const getProjectsRoadmap2Id =
			document.getElementById("projects_roadmap2");
		if (getProjectsRoadmap2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#projects_roadmap2"),
				options
			);
			chart.render();
		}
		...
		const getProjectsProgressId =
			document.getElementById("projects_progress");
		if (getProjectsProgressId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#projects_progress"),
				options
			);
			chart.render();
		}
		...
		/* Project Analysis JS */
		const getProjectAnalysisId =
			document.getElementById("project_analysis");
		if (getProjectAnalysisId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#project_analysis"),
				options
			);
			chart.render();
		}
		...
		/* Project Analysis JS */
		const getProjectAnalysis2Id =
			document.getElementById("project_analysis2");
		if (getProjectAnalysis2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#project_analysis2"),
				options
			);
			chart.render();
		}
		...
		if (getTasksOverviewId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#tasks_overview"),
				options
			);
			chart.render();
		}
		...
		if (getTasksOverview4Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#tasks_overview4"),
				options
			);
			chart.render();
		}
		...
		if (getTasksOverview3Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#tasks_overview3"),
				options
			);
			chart.render();
		}
		...
		const getStudentsInterestedTopicsId = document.getElementById(
			"student_interested_topics"
		);
		if (getStudentsInterestedTopicsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#student_interested_topics"),
				options
			);
			chart.render();
		}
		...
		if (getCoursesSalesId) {
				...
				series: [
					{
						name: "Sales",
						data: [
							100, 130, 115, 170, 110, 120, 85, 140, 150, 100,
							110, 90, 160, 125, 105, 130, 145, 120, 150, 155,
							220, 165,
						],
					},
				],
			...
			var chart = new ApexCharts(
				document.querySelector("#courses_sales"),
				options
			);
			chart.render();
		}
		...
		if (getTimeSpentId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#time_spent"),
				options
			);
			chart.render();
		}
		...
		// Tickets Resolved JS
		const getTicketsResolvedId =
			document.getElementById("tickets_resolved");
		if (getTicketsResolvedId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#tickets_resolved"),
				options
			);
			chart.render();
		}
		...
		if (getTicketsDueId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#tickets_due"),
				options
			);
			chart.render();
		}
		...
		if (getTicketsNewOpenId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#tickets_new_open"),
				options
			);
			chart.render();
		}
		...
		if (getCustomerSatisfactionId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#customer_satisfaction"),
				options
			);
			chart.render();
		}
		...
		// Customer Satisfaction JS
		const getCustomerSatisfaction2Id = document.getElementById(
		...
		if (getCustomerSatisfaction2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#customer_satisfaction2"),
				options
			);
			chart.render();
		}
		...
		if (getResponseTimeId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#response_time"),
				options
			);
			chart.render();
		}
		...
		if (getResponseTime2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#response_time2"),
				options
			);
			chart.render();
		}
		...
		const getNewTicketsVsSolvedTicketsId = document.getElementById(
			"new_tickets_vs_solved_tickets"
		);
		if (getNewTicketsVsSolvedTicketsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#new_tickets_vs_solved_tickets"),
				options
			);
			chart.render();
		}
		...
		if (getTasksOverview2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#tasks_overview2"),
				options
			);
			chart.render();
		}
		...
		if (getNewVsSolvedId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#new_vs_solved"),
				options
			);
			chart.render();
		}
		...
		const getAnalyticsOverviewId =
			document.getElementById("analytics_overview");
		if (getAnalyticsOverviewId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#analytics_overview"),
				options
			);
			chart.render();
		}
				...
				series: [
					{
						name: "Users",
						data: [
							100, 90, 85, 95, 100, 100, 90, 85, 95, 100, 100, 90,
							85, 95, 100, 100, 90, 85, 95, 100, 100, 90, 85, 95,
		...
		if (getDeviceSessionsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#device_sessions"),
				options
			);
			chart.render();
		}
		...
		if (getWebsiteVisitsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#website_visits"),
				options
			);
			chart.render();
		}
		...
		if (getNewRegistersId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#new_registers"),
				options
			);
			chart.render();
		}
				...
				series: [
					{
						name: "Impressions",
						data: [
							100, 110, 90, 160, 125, 105, 130, 145, 120, 150,
							155, 220, 165, 100, 130, 115, 170, 110, 120, 85,
							140, 150,
						],
					},
				],
				...
				series: [
					{
						name: "Sessions",
						data: [
							110, 120, 85, 130, 145, 120, 150, 155, 100, 130,
							115, 170, 220, 165, 140, 150, 100, 110, 90, 160,
							125, 105,
						],
					},
				],
		...
		const getSessionsByChannelId = document.getElementById(
			"sessions_by_channel"
		);
		if (getSessionsByChannelId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#sessions_by_channel"),
				options
			);
			chart.render();
		}
		...
		if (getCardanoId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#cardano"),
				options
			);
			chart.render();
		}
		...
		const getMarketPriceStatisticsId = document.getElementById(
		...
		if (getMarketPriceStatisticsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#market_price_statistics"),
				options
			);
			chart.render();
		}
		...
		if (getTotalRevenuesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#total_revenues"),
				options
			);
			chart.render();
		}
		...
		if (getRecentEarningsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#recent_earnings"),
				options
			);
			chart.render();
		}
		...
		if (getRealTimeSalesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#real_time_sales"),
				options
			);
			chart.render();
		}
		...
		if (getSalesOverviewId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#sales_overview"),
				options
			);
			chart.render();
		}
		...
		if (getGrossEarningsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#gross_earnings"),
				options
			);
			chart.render();
		}
		...
		/* Overall Visitors JS*/
		const getOverallVisitorsId =
			document.getElementById("overall_visitors");
		if (getOverallVisitorsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#overall_visitors"),
				options
			);
			chart.render();
		}
		...
		const getPatientsLast7DaysServiceId = document.getElementById(
			"patients_last_7_days_service"
		);
		if (getPatientsLast7DaysServiceId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#patients_last_7_days_service"),
				options
			);
			chart.render();
		}
		...
		const getPatientAdmissionsDischargesId = document.getElementById(
			"patient_admissions_discharges"
		);
		if (getPatientAdmissionsDischargesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#patient_admissions_discharges"),
				options
			);
			chart.render();
		}
		...
		const getEmergencyRoomVisitsId = document.getElementById(
		...
		if (getEmergencyRoomVisitsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#emergency_room_visits"),
				options
			);
			chart.render();
		}
		...
		const getCriticalPatientsId =
			document.getElementById("critical_patients");
		if (getCriticalPatientsId) {
				...
				series: [
					{
						name: "Orthopedics",
						data: [
							10, 15, 21, 25, 19, 15, 25, 20, 20, 15, 21, 25, 17,
							18, 15, 20, 15, 20, 18, 13,
						],
					},
					{
						name: "Cardiology",
						data: [
							3, 7, 7, 10, 9, 7, 15, 3, 7, 7, 10, 9, 7, 13, 3, 7,
							7, 10, 9, 7,
						],
					},
				],
			...
			var chart = new ApexCharts(
				document.querySelector("#critical_patients"),
				options
			);
			chart.render();
		}
		...
		const getBedOccupancyRateId =
			document.getElementById("bed_occupancy_rate");
		if (getBedOccupancyRateId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#bed_occupancy_rate"),
				options
			);
			chart.render();
		}
		...
		if (getTotalEarningsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#total_earnings"),
				options
			);
			chart.render();
		}
		...
		const gePerformanceOverviewId = document.getElementById(
		...
		if (gePerformanceOverviewId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#performance_overview"),
				options
			);
			chart.render();
		}
		...
		const getInstagramCampaignsId = document.getElementById(
			"instagram_campaigns"
		);
		if (getInstagramCampaignsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#instagram_campaigns"),
				options
			);
			chart.render();
		}
		...
		const getInstagramSubscriberId = document.getElementById(
			"instagram_subscriber"
		);
		if (getInstagramSubscriberId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#instagram_subscriber"),
				options
			);
			chart.render();
		}
		...
		if (getEthereumRateId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#ethereum_rate"),
				options
			);
			chart.render();
		}
		...
		if (getEthereumRate2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#ethereum_rate2"),
				options
			);
			chart.render();
		}
		...
		if (getEthereumRate3Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#ethereum_rate3"),
				options
			);
			chart.render();
		}
		...
		if (getEthereumRate4Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#ethereum_rate4"),
				options
			);
			chart.render();
		}
		...
		if (getEthereumRate5Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#ethereum_rate5"),
				options
			);
			chart.render();
		}
		...
		if (getTodayPaymentId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#today_payment"),
				options
			);
			chart.render();
		}
		...
		if (getActiveUserId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#active_user"),
				options
			);
			chart.render();
		}
		...
		if (getRevenueTwoId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#revenue_two"),
				options
			);
			chart.render();
		}
		...
		if (getActiveUsersId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#active_users"),
				options
			);
			chart.render();
		}
		...
		const getProductTradeConditionId = document.getElementById(
			"product_trade_condition"
		);
		if (getProductTradeConditionId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#product_trade_condition"),
				options
			);
			chart.render();
		}
		...
		if (getGrossRevenueId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#gross_revenue"),
				options
			);
			chart.render();
		}
		...
		/* Property Revenue JS*/
		const getPropertyRevenueId =
			document.getElementById("property_revenue");
		if (getPropertyRevenueId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#property_revenue"),
				options
			);
			chart.render();
		}
		...
		const getNewListingsVsSoldPropertiesId = document.getElementById(
			"new_listings_vs_sold_properties"
		);
		if (getNewListingsVsSoldPropertiesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#new_listings_vs_sold_properties"),
				options
			);
			chart.render();
		}
		...
		const getPropertiesForSaleId = document.getElementById(
			"properties_for_sale"
		);
		if (getPropertiesForSaleId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#properties_for_sale"),
				options
			);
			chart.render();
		}
		...
		const getPropertiesForRentId = document.getElementById(
			"properties_for_rent"
		);
		if (getPropertiesForRentId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#properties_for_rent"),
				options
			);
			chart.render();
		}
		...
		if (getRentalIncomeId) {
				...
				series: [
					{
						name: "Time Spent",
						data: [
							400, 500, 300, 650, 220, 400, 380, 750, 350, 250,
							200, 100,
						],
					},
				],
			...
			var chart = new ApexCharts(
				document.querySelector("#rental_income"),
				options
			);
			chart.render();
		}
		...
		if (getSocialSearchId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#social_search"),
				options
			);
			chart.render();
		}
		...
		const getShipmentDeliveredId =
			document.getElementById("shipment_delivered");
		if (getShipmentDeliveredId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#shipment_delivered"),
				options
			);
			chart.render();
		}
		...
		const getAverageDeliveryTimeId = document.getElementById(
		...
		if (getAverageDeliveryTimeId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#average_delivery_time"),
				options
			);
			chart.render();
		}
		...
		const getLiveShipmentStatusId = document.getElementById(
			"live_shipment_status"
		);
		if (getLiveShipmentStatusId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#live_shipment_status"),
				options
			);
			chart.render();
		}
		...
		const getTopShippingMethodsId = document.getElementById(
		...
		if (getTopShippingMethodsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#top_shipping_methods"),
				options
			);
			chart.render();
		}
		...
		/* Todays Shipments JS */
		const getTodaysShipmentsId =
			document.getElementById("todays_shipments");
		if (getTodaysShipmentsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#todays_shipments"),
				options
			);
			chart.render();
		}
		...
		if (getOnTimeDeliveryId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#on_time_delivery"),
				options
			);
			chart.render();
		}
		...
		if (getWeeklyExpensesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#weekly_expenses"),
				options
			);
			chart.render();
		}
		...
		if (getNetProfitId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#net_profit"),
				options
			);
			chart.render();
		}
		...
		if (getTotalEmployeesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#total_employees"),
				options
			);
			chart.render();
		}
		...
		const getResignedEmployeesId =
			document.getElementById("resigned_employees");
		if (getResignedEmployeesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#resigned_employees"),
				options
			);
			chart.render();
		}
		...
		if (getNewEmployeesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#new_employees"),
				options
			);
			chart.render();
		}
		...
		const getEmployeeAttendanceTrendsId = document.getElementById(
			"employee_attendance_trends"
		);
		if (getEmployeeAttendanceTrendsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#employee_attendance_trends"),
				options
			);
			chart.render();
		}
		...
		const getEmployeeWorkFormatId = document.getElementById(
		...
		if (getEmployeeWorkFormatId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#employee_work_format"),
				options
			);
			chart.render();
		}
		...
		if (getEmployeeSalaryId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#employee_salary"),
				options
			);
			chart.render();
		}
		...
		const getAttendanceAnalyticsId = document.getElementById(
		...
		if (getAttendanceAnalyticsId) {
				...
				series: [
					{
						name: "Teachers",
						data: [
							500, 600, 250, 600, 200, 500, 600, 120, 250, 500,
							200, 250,
						],
					},
					{
						name: "Boys",
						data: [
							200, 300, 200, 400, 200, 250, 350, 120, 250, 300,
							120, 200,
						],
					},
					{
						name: "Girls",
						data: [
							150, 250, 200, 300, 300, 150, 200, 300, 200, 250,
							400, 200,
						],
					},
				],
			...
			var chart = new ApexCharts(
				document.querySelector("#attendance_analytics"),
				options
			);
			chart.render();
		}
		...
		const getStudentsOverviewId =
			document.getElementById("students_overview");
		if (getStudentsOverviewId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#students_overview"),
				options
			);
			chart.render();
		}
		...
		if (getNewAdmissionsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#new_admission"),
				options
			);
			chart.render();
		}
		...
		if (getTotalCallsId) {
				...
				series: [
					{
						name: "Total Calls",
						data: [
							200, 150, 300, 250, 500, 400, 700, 600, 900, 800,
							1200, 1300,
						],
					},
				],
			...
			var chart = new ApexCharts(
				document.querySelector("#total_calls"),
				options
			);
			chart.render();
		}
		...
		if (getAnsweredCallsId) {
				...
				series: [
					{
						name: "Total Calls",
						data: [
							800, 150, 700, 250, 500, 400, 700, 300, 900, 800,
							1200, 600,
						],
					},
				],
			...
			var chart = new ApexCharts(
				document.querySelector("#answered_calls"),
				options
			);
			chart.render();
		}
		...
		if (getMissedCallsId) {
				...
				series: [
					{
						name: "Total Calls",
						data: [
							200, 150, 500, 250, 500, 400, 700, 600, 900, 800,
							600, 1300,
						],
					},
				],
			...
			var chart = new ApexCharts(
				document.querySelector("#missed_calls"),
				options
			);
			chart.render();
		}
		...
		if (getInboundCallsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#inbound_calls"),
				options
			);
			chart.render();
		}
		...
		if (getOutboundCallsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#outbound_calls"),
				options
			);
			chart.render();
		}
		...
		const getAgentAvgEarningsId =
			document.getElementById("agent_avg_earnings");
		if (getAgentAvgEarningsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#agent_avg_earnings"),
				options
			);
			chart.render();
		}
		...
		const getAgentAvgEarnings2Id = document.getElementById(
			"agent_avg_earnings2"
		);
		if (getAgentAvgEarnings2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#agent_avg_earnings2"),
				options
			);
			chart.render();
		}
		...
		const getAgentAvgEarnings3Id = document.getElementById(
			"agent_avg_earnings3"
		);
		if (getAgentAvgEarnings3Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#agent_avg_earnings3"),
				options
			);
			chart.render();
		}
		...
		const getAgentAvgEarnings4Id = document.getElementById(
			"agent_avg_earnings4"
		);
		if (getAgentAvgEarnings4Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#agent_avg_earnings4"),
				options
			);
			chart.render();
		}
		...
		const getAgentAvgEarnings5Id = document.getElementById(
			"agent_avg_earnings5"
		);
		if (getAgentAvgEarnings5Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#agent_avg_earnings5"),
				options
			);
			chart.render();
		}
		...
		const getPatientRetentionId =
			document.getElementById("patient_retention");
		if (getPatientRetentionId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#patient_retention"),
				options
			);
			chart.render();
		}
		...
		const getPatientDistributionId = document.getElementById(
		...
		if (getPatientDistributionId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#patient_distribution"),
				options
			);
			chart.render();
		}
		...
		const getIncomeVsExpenseId =
			document.getElementById("income_vs_expense");
		if (getIncomeVsExpenseId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#income_vs_expense"),
				options
			);
			chart.render();
		}
		...
		const getCustomerSatisfactionRateId = document.getElementById(
		...
		if (getCustomerSatisfactionRateId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#customer_satisfaction_rate"),
				options
			);
			chart.render();
		}
		...
		const getRevenueByServicesId = document.getElementById(
			"revenue_by_services"
		);
		if (getRevenueByServicesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#revenue_by_services"),
				options
			);
			chart.render();
		}
		...
		if (getGrossRevenue2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#gross_revenue2"),
				options
			);
			chart.render();
		}
		...
		if (getSalesByGenderId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#sales_by_gender"),
				options
			);
			chart.render();
		}
		...
		if (getSalesThisMonthId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#sales_this_month"),
				options
			);
			chart.render();
		}
		...
		const getLinkedinNetFollowersId = document.getElementById(
			"linkedin_net_followers"
		);
		if (getLinkedinNetFollowersId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#linkedin_net_followers"),
				options
			);
			chart.render();
		}
		...
		const getFollowersByGenderId = document.getElementById(
			"followers_by_gender"
		);
		if (getFollowersByGenderId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#followers_by_gender"),
				options
			);
			chart.render();
		}
		...
		const getFacebookCampaignOverviewId = document.getElementById(
			"facebook_campaign_overview"
		);
		if (getFacebookCampaignOverviewId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#facebook_campaign_overview"),
				options
			);
			chart.render();
		}
		...
		if (getSalesOverTimeId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#sales_over_time"),
				options
			);
			chart.render();
		}
		...
		const getSalesByCategoryProductsId = document.getElementById(
			"sales_by_category_products"
		);
		if (getSalesByCategoryProductsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#sales_by_category_products"),
				options
			);
			chart.render();
		}
		...
		const getCustomerSegmentationId = document.getElementById(
		...
		if (getCustomerSegmentationId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#customer_segmentation"),
				options
			);
			chart.render();
		}
		...
		if (getTodaysEarningsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#todays_earnings"),
				options
			);
			chart.render();
		}
		...
		const getListenerAnalyticsId =
			document.getElementById("listener_analytics");
		if (getListenerAnalyticsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#listener_analytics"),
				options
			);
			chart.render();
		}
		...
		const getSalesByGender2Id =
			document.getElementById("sales_by_gender_2");
		if (getSalesByGender2Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#sales_by_gender_2"),
				options
			);
			chart.render();
		}
		...
		const getProductTrendsByMonthId = document.getElementById(
			"product_trends_by_month"
		);
		if (getProductTrendsByMonthId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#product_trends_by_month"),
				options
			);
			chart.render();
		}
		...
		const getAverageHighLowTemperatureId = document.getElementById(
			"average_high_low_temperature"
		);
		if (getAverageHighLowTemperatureId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#average_high_low_temperature"),
				options
			);
			chart.render();
		}
		...
		if (getPageStatisticsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#page_statistics"),
				options
			);
			chart.render();
		}
		...
		const getAreawithNegativeValuesId = document.getElementById(
			"area_with_negative_values"
		);
		if (getAreawithNegativeValuesId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#area_with_negative_values"),
				options
			);
			chart.render();
		}
		...
		if (getBasicBarId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#basic_bar"),
				options
			);
			chart.render();
		}
		...
		if (getGroupedId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#grouped"),
				options
			);
			chart.render();
		}
		...
		if (getColumnId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#basic_column"),
				options
			);
			chart.render();
		}
		...
		const getColumnWithDataLabelsId = document.getElementById(
			"column_with_data_labels"
		);
		if (getColumnWithDataLabelsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#column_with_data_labels"),
				options
			);
			chart.render();
		}
