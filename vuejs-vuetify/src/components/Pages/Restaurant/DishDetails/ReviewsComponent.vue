<template>
  <v-card
    class="reviews-card trezo-card bg-white border-radius d-block border-0 shadow-none"
  >
  ...
  setup() {
    const reviews = ref<Review[]>([
      ...
      },
      {
        id: 10,
        code: "#010",
        image: require("@/assets/images/users/user67.jpg"),
      ...
      },
      {
        id: 11,
        code: "#011",
        image: require("@/assets/images/users/user68.jpg"),
        name: "Daniel Brown",
        rating: 3.0,
