          ...
          <div class="row">
            <div class="col-md-6">
              <div class="trezo-form-group">
                <v-label class="d-block fw-medium text-black"> Code </v-label>
                <v-text-field
                  label="Enter Code"
                  placeholder="#001"
                  required
            ...
            <div class="col-md-6">
              <div class="trezo-form-group">
                ...
                <v-text-field type="date" required></v-text-field>
              </div>
            </div>
            <div class="col-md-6">
              <div class="trezo-form-group">
            ...
            <div class="col-md-6">
              <div class="trezo-form-group">
                <v-label class="d-block fw-medium text-black"> Room </v-label>
                <v-text-field
                  label="Enter Room No"
                  placeholder="G0-12"
                  required
            ...
            <div class="col-md-12">
              <div class="trezo-form-group">
                <v-label class="d-block fw-medium text-black"> Avatar </v-label>
                <FileUploader />
              </div>
            </div>
          </div>
          <div class="btn-box">
            <button @click="isActive.value = false" class="warn">Cancel</button>
