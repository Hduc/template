<template>
  <v-card
    class="customers-from-channels-card trezo-card border-radius d-block bg-white border-0 shadow-none"
  >
        ...
        >
          <div class="title d-flex align-items-center">
            ...
            <div>
              ...
              <span class="d-block">{{ channel.description }}</span>
            </div>
          </div>
          <div class="percentage-progress d-flex align-items-center">
            ...
            >
              <div
                class="progress-bar"
                :class="channel.progressBarClass"
                :style="{ width: channel.percentage + '%' }"
              ></div>
            </div>
            <span class="d-block percentage">{{ channel.percentage }}%</span>
          </div>
        </li>
      </ul>
    </div>
      ...
      channels: [
        {
          ...
          icon: require("@/assets/images/icons/facebook3.svg"),
          percentage: 50,
          progressBarClass: "",
        },
        {
          name: "Dribbble",
          description: "Community",
          icon: require("@/assets/images/icons/dribbble2.svg"),
          percentage: 75,
        ...
        },
        {
          name: "Google",
          description: "SEO & PPC",
          icon: require("@/assets/images/icons/google3.svg"),
          percentage: 20,
