<template>
  <v-card
    class="todays-schedule-card trezo-card border-radius d-block bg-white border-0 shadow-none"
  >
      ...
      <div class="events-list position-relative scrollbar">
        ...
        >
          ...
          <div class="info d-flex align-items-center justify-content-between">
            <button type="button" class="btn border-radius btn-primary">
              View Details
            </button>
            <button
              type="button"
          ...
          <div class="shape position-absolute z-n1 end-0 top-0">
            <v-img src="@/assets/images/cut-circle.png" alt="cut-circle" />
          </div>
        </div>
      </div>
    </div>
