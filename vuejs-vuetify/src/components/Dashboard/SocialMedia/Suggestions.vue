<template>
  <v-card
    class="suggestions-card trezo-card border-radius d-block bg-white border-0 shadow-none"
  >
      ...
      <ul class="p-0 m-0 list-unstyled">
        ...
        >
          <div class="user d-flex align-items-center">
            <v-img :src="user.image" class="rounded-circle" alt="user-image" />
            <div>
...
export default defineComponent({
  ...
  setup() {
    const users = ref<User[]>([
      ...
      {
        name: "Ethan Clarke",
        image: require("@/assets/images/users/user41.jpg"),
        mutualFriends: 10,
      },
      {
        name: "Isabella Cruz",
        image: require("@/assets/images/users/user43.jpg"),
        mutualFriends: 7,
      },
    ]);
