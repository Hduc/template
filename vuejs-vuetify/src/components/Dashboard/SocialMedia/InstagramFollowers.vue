<template>
  <v-card
    class="instagram-followers-card trezo-card border-radius d-block bg-white border-0 shadow-none"
  >
    <div class="trezo-card-content">
      <v-img src="@/assets/images/icons/instagram3.svg" alt="instagram" />
