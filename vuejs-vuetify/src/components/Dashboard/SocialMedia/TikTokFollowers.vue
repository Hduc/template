<template>
  <v-card
    class="tiktok-followers-card trezo-card border-radius d-block bg-white border-0 shadow-none"
  >
    <div class="trezo-card-content">
      <v-img src="@/assets/images/icons/tiktok.svg" alt="tiktok" />
      <h3 class="fw-medium">132k</h3>
