<template>
    <v-card
        class="projects-roadmap-card trezo-card mb-25 border-radius d-block bg-white border-0 shadow-none"
    >
        <div class="v-card-header">
            <h5 class="mb-0">Project Roadmap</h5>
            <v-menu>
