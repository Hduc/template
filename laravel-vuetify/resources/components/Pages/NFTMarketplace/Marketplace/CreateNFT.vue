<template>
    <v-dialog width="100%" height="100%">
        <template v-slot:activator="{ props: activatorProps }">
            <button v-bind="activatorProps" class="create-nft-btn">
                Create NFT
            </button>
        </template>
                ...
                <div class="dialog-content">
                    ...
                    >
                        ...
                        <div class="mb-4 only-file-upload">
                            ...
                            >
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="fs-16">
                                        Drop campaign files here or click to
                                        upload.
                                    </h4>
                                    <p>
                                        Upload upto 12 files, max size each
                                        file: 5MB.
                                    </p>
                                </div>
                                <label
                        ...
                        <div class="d-flex flex-wrap ga-3 mb-4">
                            <div
                                class="d-flex align-items-center form-check style"
                            >
                                <div class="flex-shrink-0">
                                    <input
