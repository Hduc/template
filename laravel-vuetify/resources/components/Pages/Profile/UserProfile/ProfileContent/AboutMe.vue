<template>
    <v-card
        class="about-me-card trezo-card border-radius d-block bg-white border-0 shadow-none"
    >
        ...
        <div class="about-me-content">
            ...
            <p>
                ...
                solidified Alice's commitment to enhancing user experiences.
            </p>
            <h6>Expertise in UX/UI Design</h6>
            <p>
