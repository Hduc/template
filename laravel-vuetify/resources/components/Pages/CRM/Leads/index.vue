<template>
    <v-card
        class="crm-leads-card trezo-card mt-25 border-radius d-block bg-white border-0 shadow-none"
    >
                    ...
                    <tbody>
                        <tr v-for="item in filteredItems" :key="item.id">
                            ...
                            <td>
                                ...
                                <span
                                    class="trezo-status-badge inProgress"
                                    v-if="item.status.inProgress"
                                >
                                    In Progress
                                </span>
                                <span
                                    class="trezo-status-badge pending"
...
import AddNewLead from "./AddNewLead.vue";
