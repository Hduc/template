            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="trezo-form-group">
                        ...
                        <v-select
                            label="Select"
                            :items="['9AM - 10AM', '11AM - 12PM', '2PM - 4PM']"
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="trezo-form-group">
                        ...
                        <v-text-field
                            ...
                            v-model="formData.eventOrganizers"
                            required
                        ></v-text-field>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="trezo-form-group">
                        ...
                        <v-text-field
                            ...
                            placeholder="E.g. Hand Watch"
                            v-model="formData.eventSponsors"
                            required
                        ></v-text-field>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="trezo-form-group">
                        ...
                        <TextEditor v-model="formData.eventDetails" />
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="trezo-form-group">
                        ...
                        <FileUploader style="min-height: 190px" />
                    </div>
                </div>
            </div>
...
export default defineComponent({
    ...
    setup() {
        const formData = ref({
            ...
            eventPrice: "$20.00",
            eventMode: "Online",
            eventTopic: "Pepper Festival",
            eventVenue: "2750 Quadra Street Victoria Road",
            ...
            eventOrganizers: "Hand Watch",
            eventSponsors: "Hand Watch",
            eventDetails: "",
        });
        return {
            formData,
