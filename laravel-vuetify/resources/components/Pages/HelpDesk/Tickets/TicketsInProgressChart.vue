<template>
    <v-card
        class="tickets-in-progress-card trezo-card border-radius d-block bg-white border-0 shadow-none"
    >
        <div class="progress-card-content">
            <span class="d-block"> Tickets In Progress </span>
            <h5 class="mb-0">1.35k</h5>
            <div class="chart">
                <apexchart
                    v-if="isClient"
                    type="area"
