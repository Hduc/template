                        ...
                        <div class="col-lg-6 col-md-12">
                            ...
                            >
                                ...
                                <div class="countdown-container">
                                    <div
                                        class="countdown-value lh-1 text-warning fw-bold"
                                    >
                                        {{ countdown.days }}
                                    </div>
                                    <div class="countdown-label fw-light lh-1">
                                        Days
                                    </div>
                                    <div
                                        class="countdown-item position-relative d-inline-block"
                                    >
                                        <div
                                            class="countdown-value lh-1 text-warning fw-bold"
                                        >
                                        ...
                                        <div
                                            class="countdown-label fw-light lh-1"
                                        >
                                            Hours
                                        </div>
                                    </div>
                            ...
                            <div class="coming-soon-content">
                                ...
                                <div class="title">
                                    <h1 class="fw-semibold">
                                        We're working on launching soon, stay
                                        tuned!
                                    </h1>
                                ...
                                <form>
                                    <div class="trezo-form-group">
                                        <v-label
                                            class="main-label d-block fw-medium text-black"
                                        >
                                            Be the first to know when our site
                                            is live
                                        </v-label>
                                        <v-text-field
...
import congImg from "../../../../../public/images/coming-soon.jpg";
