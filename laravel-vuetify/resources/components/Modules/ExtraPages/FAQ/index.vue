<template>
    <v-card
        class="faq-card mb-25 border-radius d-block bg-white border-0 shadow-none"
    >
        <div class="faq-card-content">
            <div class="title text-center ml-auto mr-auto">
                <h3>Frequently Asked Questions</h3>
                <p>
                    Trezo offers customization options to tailor the platform to
                    your team's unique requirements. You can customize
                    workflows, templates, and dashboards to align with your
                    processes.
                </p>
            </div>
            <v-expansion-panels v-model="panel" class="d-block ml-auto mr-auto">
                <v-expansion-panel>
                    ...
                    <v-expansion-panel-text>
                        <p>
                            Trezo is a comprehensive project management software
                            designed to help teams streamline their workflow,
                            collaborate effectively, and achieve project
                            success.
                        </p>
                    </v-expansion-panel-text>
                </v-expansion-panel>
                    ...
                    <v-expansion-panel-text>
                        ...
                        <ul>
                            <li class="position-relative">
                                Pellentesque viverra lorem malesuada nunc
                                tristique sapien.
                            </li>
                            <li class="position-relative">
                                Imperdiet sit hendrerit tincidunt bibendum donec
                                adipiscing.
                            </li>
                            <li class="position-relative">
                                Tellus non morbi nascetur cursus etiam facilisis
                                mi.
                            </li>
                            <li class="position-relative">
                                Imperdiet sit hendrerit tincidunt bibendum donec
