            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 order-1 order-lg-2">
                    <div class="form-content">
                        <div class="logo">
                            <v-img src="/images/logo-big.svg" alt="logo" />
                            <v-img
                        ...
                        <div class="title">
                            ...
                            <p class="fw-medium">
                                Your mail is verified! Your account is now safe
                                from unwanted activities.
                            </p>
                        </div>
                        <div class="admin">
                            <div
                                class="logo d-flex align-items-center justify-content-center bg-gray text-success rounded-circle"
                            >
                        ...
                        <RouterLink class="back-btn" to="/dashboard">
