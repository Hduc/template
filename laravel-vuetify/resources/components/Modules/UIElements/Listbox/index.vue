    ...
    <v-row>
        <v-col cols="12" lg="4" md="6">
            <v-card class="trezo-card">
                ...
                <div class="listbox-container">
                    <label
                        class="listbox-label fw-semibold"
                        id="fav-color-label"
                    >
                        Favorite color
                    </label>
            ...
            <v-card class="trezo-card">
                ...
                <div class="listbox-container">
                    ...
                    <ul cdkListbox class="listbox">
                        <li class="option">😀 Great</li>
                        <li class="option">😐 Okay</li>
                        <li class="option">🙁 Bad</li>
                    </ul>
                </div>
            </v-card>
        </v-col>
        <v-col cols="12" lg="4" md="6">
            <v-card class="trezo-card">
                ...
                <label class="example-listbox-label fw-semibold">
                    Shirt Size:
                </label>
                <ul class="example-listbox mt-5">
                    <li
                        v-for="size in sizes"
                        :key="size.id"
                        cdkOption="size"
                        class="example-option gray-color fw-semibold"
                    >
                        {{ size }}
                    </li>
                </ul>
