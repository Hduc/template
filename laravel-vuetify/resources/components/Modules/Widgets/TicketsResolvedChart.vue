<template>
    <v-card
        class="tickets-resolved-card trezo-card border-radius d-block bg-white border-0 shadow-none"
    >
        <div class="resolved-card-content">
            <span class="d-block"> Tickets Resolved </span>
