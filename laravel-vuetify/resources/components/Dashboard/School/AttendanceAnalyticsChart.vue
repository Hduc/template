<template>
    <v-card
        class="attendance-analytics-card trezo-card border border-radius d-block bg-white custom-shadow"
    >
        ...
        const attendance = ref([
            {
                name: "Teachers",
                data: [
                    500, 600, 250, 600, 200, 500, 600, 120, 250, 500, 200, 250,
                ],
            },
            {
                name: "Boys",
                data: [
                    200, 300, 200, 400, 200, 250, 350, 120, 250, 300, 120, 200,
                ],
            },
            {
                name: "Girls",
                data: [
                    150, 250, 200, 300, 300, 150, 200, 300, 200, 250, 400, 200,
                ],
            },
        ]);
