<template>
    <v-row class="mb-4">
        <v-col xl="3" lg="3" sm="6">
            <v-card
                class="trezo-card custom-shadow for-dark-rounded-bg rounded-3 p-0"
                style="
            ...
            >
                <div class="v-card-header mb-0" style="padding: 14.5px 25px">
                    ...
                    <div
                        class="dropdown action-opt right-for-rtl"
                        style="right: -8px"
                    >
                        <v-menu>
                ...
                <div class="bg-white p-4 rounded-2">
                    ...
                    >
                        <h3 class="fs-24 fw-semibold mb-0">$75,000</h3>
                        <div
                    ...
                    <div class="d-flex align-items-center">
                        <span
                            class="material-symbols-outlined fs-20 text-success me-2"
                        >
                            trending_up
                        </span>
        ...
        <v-col xl="3" lg="3" sm="6">
            ...
            >
                <div class="v-card-header mb-0" style="padding: 14.5px 25px">
                    <h3 class="mb-0 fs-16 fw-normal text-white">
                        Total Transactions
                    </h3>
                ...
                <div class="bg-white p-4 rounded-2">
                    <div
                        class="d-flex align-items-center justify-content-between mb-3"
                    >
                        <h3 class="fs-24 fw-semibold mb-0">1200</h3>
                        <div
                            class="d-flex align-items-center justify-content-center rounded-circle"
                            style="
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="text-body"
                            ><span class="fw-semibold">+10%</span> from last
                            month</span
                        >
                    </div>
                </div>
            ...
            >
                ...
                <div class="bg-white p-4 rounded-2">
                    <div
                        class="d-flex align-items-center justify-content-between mb-3"
                    >
                        <h3 class="fs-24 fw-semibold mb-0">$40</h3>
                        <div
                            class="d-flex align-items-center justify-content-center rounded-circle"
                            style="
                    ...
                    <div class="d-flex align-items-center">
                        <span
                            class="material-symbols-outlined fs-20 text-danger me-2"
                        >
                            trending_down
                        </span>
                        <span class="text-body">
            ...
            >
                ...
                <div class="bg-white p-4 rounded-2">
                    <div
                        class="d-flex align-items-center justify-content-between mb-3"
                    >
                        <h3 class="fs-24 fw-semibold mb-0">$5,200</h3>
                        <div
                            class="d-flex align-items-center justify-content-center rounded-circle"
                            style="
