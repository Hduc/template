<template>
    <v-card
        class="top-refers-card trezo-card border-radius d-block border-0 shadow-none"
    >
        <div class="v-card-header">
            <h5 class="mb-0">Top Refers</h5>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="flex-shrink-0">
                        <div class="d-flex">
                            ...
                            />
                            <div class="ms-3">
                                <h4 class="mb-0 fs-14 fw-semibold lh-1">
                                    Facebook
                                </h4>
...
.mb-4 {
    margin-bottom: 17.2px !important;
}
</style>
