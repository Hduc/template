<template>
    <v-card
        class="active-auctions-card trezo-card border-radius d-block border-0 shadow-none"
    >
        ...
        <div class="default-table-area style-two campaigns-table">
                ...
                >
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td
                                class="fs-12 border-bottom fw-semibold text-body"
                            >
                                11.75 ETH
                            </td>
                            <td
                            ...
                            <td class="border-bottom">
                                <div class="d-flex align-items-center">
                                    ...
                                    />
                                    <span
                                        class="text-body fs-12 fw-semibold ms-2"
                                    >
                                        10.08 ETH
                                    </span>
                                </div>
            ...
            <Pagination
                items="05"
                total="30"
                class="pb-0 pl-0 pr-0 border-none"
            />
        </div>
    </v-card>
</template>
