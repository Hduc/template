<template>
    <div
        class="border-0 rounded-3 position-relative z-1 play-for-rtl"
        ...
        >
            <SwiperSlide v-for="(slide, index) in slides" :key="index">
                ...
                >
                    ...
                    <h3 class="fs-28 fw-medium text-white mb-1">
                        {{ slide.title }}
                    </h3>
                    <p
                        class="text-light"
                        style="max-width: 370px; margin-bottom: 18px"
                    >
                        {{ slide.description }}
                    </p>
                    <div class="d-flex flex-wrap ga-2 align-items-center">
                        <div
                    ...
                    <div class="audio-player-for-wave" style="padding: 47px 0">
                        <div class="d-sm-flex align-items-center">
                            ...
                            <div class="ms-sm-3 mt-3 mt-sm-0">
                                ...
                                >
                                    <div
                                        class="wave-container d-flex align-items-end"
                                    >
                                        <span
                    ...
                    <div class="d-flex flex-wrap ga-4 align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-10">
                                <span class="text-light fs-12 fw-semibold lh-1"
                                    >Listens</span
                                >
                                <span
                                    class="d-block text-white fs-14 fw-medium lh-1"
                                >
                                    {{ slide.listens }}
                                </span>
                            </div>
...
import shape15 from "../../../../public/images/shape-15.png";
import shape16 from "../../../../public/images/shape-16.png";
import shape17 from "../../../../public/images/shape-17.png";
