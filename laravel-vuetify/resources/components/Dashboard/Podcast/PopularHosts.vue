                    ...
                    <tbody>
                        <tr v-for="host in hosts" :key="host.id">
                            ...
                            <td class="border-bottom">
                                ...
                                <span class="d-block fs-12 fw-normal text-body"
                                    >Hosted</span
                                >
                            </td>
                            <td class="text-end border-bottom">
                                ...
                                >
                                    <span
                                        class="follow-text position-relative"
                                        style="top: -1px"
                                    >
                                        {{
                                            host.isFollowing
...
import user124 from "../../../../public/images/user-124.png";
import user125 from "../../../../public/images/user-125.png";
import user126 from "../../../../public/images/user-126.png";
import user127 from "../../../../public/images/user-127.png";
import user128 from "../../../../public/images/user-128.png";
