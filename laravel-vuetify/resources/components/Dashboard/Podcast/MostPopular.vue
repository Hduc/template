<template>
    <v-card
        class="most-popular-card trezo-card custom-shadow rounded-3 bg-white border custom-padding-30"
    ...
    >
        ...
        <ul
            class="nav nav-tabs ga-2 most-popular-tabs border-0 mb-20"
            id="myTab"
            role="tablist"
        >
            <li
                ...
                <div class="row">
                    ...
                    >
                        <div class="position-relative single-play mb-4">
                            ...
                            >
                                <div
                                    class="position-absolute bottom-0 start-0 ps-3 pb-3"
                                >
                                    <button
                            ...
                            <h3 class="fs-14 fw-medium mt-3 mb-2">
                                {{ item.title }}
                            </h3>
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="d-flex align-items-center ms-4">
                                    ...
                                    ></i>
                                    <span
                                        class="d-block fs-12 fw-normal text-body ms-10"
                                    >
                                        {{ item.plays }}
                                    </span>
                                </div>
...
import played7 from "../../../../public/images/played-7.jpg";
import played8 from "../../../../public/images/played-8.jpg";
import played9 from "../../../../public/images/played-9.jpg";
import played10 from "../../../../public/images/played-10.jpg";
import played11 from "../../../../public/images/played-11.jpg";
import played12 from "../../../../public/images/played-12.jpg";
