<template>
    <v-card
        class="weekly-expenses-card trezo-card border-radius d-block border-0 shadow-none"
    >
        <div class="d-flex justify-content-between flex-wrap ga-2 mb-3">
            <div>
                <div class="d-flex align-items-center">
                    <span>Weekly Expenses</span>
                    <span
                        class="d-inline-block text-white px-2 bg-danger bg-opacity-10 text-danger border border-danger rounded-pill fs-12 fw-medium ms-2"
                    >
                        -5.1%
                    </span>
                </div>
