    ...
    >
        <div class="logo bg-white">
            <RouterLink to="/dashboard" class="d-flex align-items-center">
                <v-img src="/images/logo-icon.png" alt="logo" />
                        ...
                        <AccordionItem>
                            <template v-slot:accordion-trigger>
                                <div class="title-header">
                                    ...
                                    <span class="badge rounded-circle two"
                                        >3</span
                                    >
                                    <i
                                        class="arrow-right ri-arrow-right-s-line"
                        ...
                        <AccordionItem>
                            <template v-slot:accordion-trigger>
                                <div class="title-header">
                                    ...
                                    <span class="badge rounded-circle three"
                                        >7</span
                                    >
                                    <i
                                        class="arrow-right ri-arrow-right-s-line"
