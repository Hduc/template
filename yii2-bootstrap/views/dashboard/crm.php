...
$this->title = 'CRM | Trezo - Yii2 & Bootstrap 5 Admin Dashboard Template';
?>
                ...
                <div class="card-body p-4">
                    ...
                    <ul class="ps-0 mb-0 list-unstyled border-top pt-3">
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-6.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                            ...
                            <a href="/pages/my-profile" class="wh-35 d-inline-block border text-center lh-35 rounded-circle text-decoration-none hover-bg">
                        ...
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-7.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    <h6 class="mb-0 fw-medium">Alex Davis</h6>
                                    <span>alex@trezo.com</span>
                        ...
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-8.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    <h6 class="mb-0 fw-medium">Alex Davis</h6>
                                    <span>alex@trezo.com</span>
                        ...
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-9.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    <h6 class="mb-0 fw-medium">Alex Davis</h6>
                                    <span>alex@trezo.com</span>
                        ...
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-10.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    <h6 class="mb-0 fw-medium">Alex Davis</h6>
                                    <span>alex@trezo.com</span>
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/my-profile" class="d-flex align-items-center">
                                                <img src="<?= Yii::$app->request->baseUrl ?>/images/user-11.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/my-profile" class="d-flex align-items-center">
                                                <img src="<?= Yii::$app->request->baseUrl ?>/images/user-12.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/my-profile" class="d-flex align-items-center">
                                                <img src="<?= Yii::$app->request->baseUrl ?>/images/user-13.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/my-profile" class="d-flex align-items-center">
                                                <img src="<?= Yii::$app->request->baseUrl ?>/images/user-14.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/my-profile" class="d-flex align-items-center">
                                                <img src="<?= Yii::$app->request->baseUrl ?>/images/user-15.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                                    <h6 class="fw-medium fs-14">David Brown</h6>
                                                </div>
                                            </a>
                        ...
                        <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap p-4">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination mb-0 justify-content-center">
                                    ...
                                    <li class="page-item"><a class="page-link active" href="/dashboard">1</a></li>
