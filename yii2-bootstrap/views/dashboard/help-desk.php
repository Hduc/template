...
$this->title = 'Help Desk | Trezo - Yii2 & Bootstrap 5 Admin Dashboard Template';
?>
        ...
        <div class="col-lg-4">
            <div class="card bg-white border-0 rounded-3 mb-4 position-relative">
                <div class="card-body p-4">
                    ...
                    <p>Ticket Solved</p>
                    <a href="/pages/my-profile" class="btn btn-primary fw-medium">View Profile</a>
                </div>
                <img src="<?= Yii::$app->request->baseUrl ?>/images/congratulations.gif" class="congratulations wh-150 position-absolute" alt="congratulations">
            </div>
                    ...
                    <div class="card bg-primary border-0 rounded-3 position-relative mb-4">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3 mb-lg-4">
                                ...
                                <select class="form-select month-select form-control p-0 h-auto border-0 w-90 text-white bg-transparent" style="background-position: right 0 center; background-image: url(<?= Yii::$app->request->baseUrl ?>/images/down-white.svg);" aria-label="Default select example">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <img src="<?= Yii::$app->request->baseUrl ?>/images/satisfaction.png" alt="satisfaction">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/agents" class="d-flex align-items-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/pages/instructors" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-29.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-2">
                        ...
                        <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination mb-0 justify-content-center">
                                        <li class="page-item">
                                            <a class="page-link icon" href="/dahsboard/lms" aria-label="Previous">
                                                <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                            </a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link icon" href="/dahsboard/lms" aria-label="Next">
                                                <i class="material-symbols-outlined">keyboard_arrow_right</i>
                                            </a>
                                        </li>
                                    </ul>
