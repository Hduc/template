...
$this->title = 'Project Management | Trezo - Yii2 & Bootstrap 5 Admin Dashboard Template';
?>
                                        ...
                                        <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                            <li>
                                                <a href="/pages/my-profile">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-16.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                </a>
                                            </li>
                                            <li class="ms-m-15">
                                                <a href="/pages/my-profile">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-17.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                </a>
                                            </li>
                                            <li class="ms-m-15">
                                                <a href="/pages/my-profile">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-18.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                </a>
                                            </li>
                                            <li class="ms-m-15">
                                                <a href="/pages/my-profile">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-19.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                </a>
                                            </li>
                                            <li class="ms-m-15">
                                                <a href="/pages/user-list" class="wh-34 lh-34 rounded-circle bg-primary d-block text-center text-decoration-none text-white fs-12 fw-medium border border-1 border-color-white">+55</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <tr>
                                        <th scope="col">
                                            <div class="form-check">
                                                ...
                                                <label class="position-relative top-2 ms-2" for="flexCheckDefault">Project Name</label>
                                            </div>
                                        </th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                ...
                                                <label class="fw-medium fs-14 position-relative top-0 ms-2" for="flexCheckDefault2">Web Development</label>
                                            </div>
                                        </td>
                                        <td>10 Jan 2024</td>
                                        <td>
                                            <span class="badge bg-info bg-opacity-10 text-info p-2 fs-12 fw-normal">Completed</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                ...
                                                <label class="fw-medium fs-14 position-relative top-0 ms-2" for="flexCheckDefault3">UX/UI Design</label>
                                            </div>
                                        </td>
                                        <td>05 Feb 2024</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                ...
                                                <label class="fw-medium fs-14 position-relative top-0 ms-2" for="flexCheckDefault4">React Development</label>
                                            </div>
                                        </td>
                                        <td>28 Mar 2024</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                ...
                                                <label class="fw-medium fs-14 position-relative top-0 ms-2" for="flexCheckDefault6">Python Research</label>
                                            </div>
                                        </td>
                                        <td>09 Mar 2024</td>
                                        <td>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination mb-0 justify-content-center">
                                            <li class="page-item">
                                                <a class="page-link icon" href="/pages/project-management" aria-label="Previous">
                                                    <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                                </a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link icon" href="/pages/project-management" aria-label="Next">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/project-overview">Project CyberSphere</a>
                                </td>
                                ...
                                <td>
                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                        ...
                                        <li class="ms-m-15">
                                            <a href="/pages/user-list" class="wh-34 lh-34 rounded-circle bg-primary d-block text-center text-decoration-none text-white fs-12 fw-medium border border-1 border-color-white">+10</a>
                                        </li>
                                    </ul>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/project-overview">Digital Oasis Initiative</a>
                                </td>
                                ...
                                <td>
                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                        ...
                                        <li class="ms-m-15">
                                            <a href="/pages/user-list" class="wh-34 lh-34 rounded-circle bg-primary d-block text-center text-decoration-none text-white fs-12 fw-medium border border-1 border-color-white">+04</a>
                                        </li>
                                    </ul>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/project-overview">CloudScape Evolution</a>
                                </td>
                                ...
                                <td>
                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                        ...
                                        <li class="ms-m-15">
                                            <a href="/pages/user-list" class="wh-34 lh-34 rounded-circle bg-primary d-block text-center text-decoration-none text-white fs-12 fw-medium border border-1 border-color-white">+07</a>
                                        </li>
                                    </ul>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/project-overview">Data Dynamo Drive</a>
                                </td>
                                ...
                                <td>
                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                        ...
                                        <li class="ms-m-15">
                                            <a href="/pages/user-list" class="wh-34 lh-34 rounded-circle bg-primary d-block text-center text-decoration-none text-white fs-12 fw-medium border border-1 border-color-white">+15</a>
                                        </li>
                                    </ul>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/project-overview">QuantumLeap Quest</a>
                                </td>
                                ...
                                <td>
                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                        ...
                                        <li class="ms-m-15">
                                            <a href="/pages/user-list" class="wh-34 lh-34 rounded-circle bg-primary d-block text-center text-decoration-none text-white fs-12 fw-medium border border-1 border-color-white">+03</a>
                                        </li>
                                    </ul>
                                </td>
                    ...
                    <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination mb-0 justify-content-center">
                                ...
                                <li class="page-item"><a class="page-link active" href="/pages/project-management">1</a></li>
                                <li class="page-item"><a class="page-link" href="/pages/project-management">2</a></li>
                                <li class="page-item"><a class="page-link" href="/pages/project-management">3</a></li>
                                <li class="page-item"><a class="page-link" href="/pages/project-management">4</a></li>
                                <li class="page-item">
                                    <a class="page-link icon" href="/pages/project-management" aria-label="Next">
                                        <i class="material-symbols-outlined">keyboard_arrow_right</i>
                                    </a>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="border-0 py-3 pb-0">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-20.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                    ...
                                    <tr>
                                        <td class="border-0 py-3 pb-0">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-21.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    ...
                                    <tr>
                                        <td class="border-0 py-3 pb-0">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-22.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    ...
                                    <tr>
                                        <td class="border-0 py-3 pb-0">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-23.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    ...
                                    <tr>
                                        <td class="border-0 py-3 pb-0">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-24.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-2">
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/project-overview" class="text-body">Network Infrastructure</a>
                                        </td>
                                        <td>Oliver Clark</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/project-overview" class="text-body">Cloud Migration</a>
                                        </td>
                                        <td>Ethan Baker</td>
                                        <td class="text-body">25 Apr 2024</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/project-overview" class="text-body">Website Revamp</a>
                                        </td>
                                        <td>Sophia Carter</td>
                                        <td class="text-body">20 Apr 2024</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/project-overview" class="text-body">Mobile Application</a>
                                        </td>
                                        <td>Ava Cooper</td>
                                        <td class="text-body">15 Apr 2024</td>
                                        <td class="text-body">High</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pages/project-overview" class="text-body">System Deployment</a>
                                        </td>
