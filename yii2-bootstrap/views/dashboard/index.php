...
$this->title = 'eCommerce | Trezo - Yii2 & Bootstrap 5 Admin Dashboard Template';
?>
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            <div
                                class="border-bottom position-relative top-5"
                            >
                                <h3
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            >
                                <img
                                    src="<?= Yii::$app->request->baseUrl ?>/images/welcome.png"
                                    alt="welcome"
                                />
                            </div>
                        </div>
                ...
                <div class="card-body p-4">
                    ...
                    >
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
                                    src="<?= Yii::$app->request->baseUrl ?>/images/usa.svg"
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
                                    src="<?= Yii::$app->request->baseUrl ?>/images/germany.svg"
                                    class="wh-30 rounded-circle"
                                    alt="germany"
                                />
                            </div>
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
                                    src="<?= Yii::$app->request->baseUrl ?>/images/united-kingdom.svg"
                                    class="wh-30 rounded-circle"
                                    alt="united-kingdom"
                                />
                            </div>
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
                                    src="<?= Yii::$app->request->baseUrl ?>/images/canada.svg"
                                    class="wh-30 rounded-circle"
                                    alt="canada"
                                />
                            </div>
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
                                    src="<?= Yii::$app->request->baseUrl ?>/images/portugal.svg"
                                    class="wh-30 rounded-circle"
                                    alt="portugal"
                                />
                            </div>
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
                                    src="<?= Yii::$app->request->baseUrl ?>/images/spain.svg"
                                    class="wh-30 rounded-circle"
                                    alt="spain"
                                />
                            </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/product-1.jpg"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/product-2.jpg"
                                                    class="wh-40 rounded-3"
                                                    alt="product-2"
                                                />
                                                <div
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/product-3.jpg"
                                                    class="wh-40 rounded-3"
                                                    alt="product-3"
                                                />
                                                <div
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/product-4.jpg"
                                                    class="wh-40 rounded-3"
                                                    alt="product-4"
                                                />
                                                <div
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/product-5.jpg"
                                                    class="wh-40 rounded-3"
                                                    alt="product-5"
                                                />
                                                <div
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/user-1.jpg"
                                                    class="wh-40 rounded-3"
                                                    alt="user"
                                                />
                                                <div
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/user-2.jpg"
                                                    class="wh-40 rounded-3"
                                                    alt="user"
                                                />
                                                <div
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/user-3.jpg"
                                                    class="wh-40 rounded-3"
                                                    alt="user"
                                                />
                                                <div
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/user-4.jpg"
                                                    class="wh-40 rounded-3"
                                                    alt="user"
                                                />
                                                <div
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            >
                                                <img
                                                    src="<?= Yii::$app->request->baseUrl ?>/images/user-5.jpg"
                                                    class="wh-40 rounded-3"
                                                    alt="user"
                                                />
                                                <div
