...
$this->title = 'LMS | Trezo - Yii2 & Bootstrap 5 Admin Dashboard Template';
?>
    ...
    <div class="row justify-content-center">
        <div class="col-xxl-6">
            <div class="card bg-primary border-0 rounded-3 welcome-box style-two mb-4 position-relative">
                ...
                <img src="<?= Yii::$app->request->baseUrl ?>/images/welcome-2.gif" class="welcome-2 d-none d-sm-block" alt="welcome">
            </div>
        </div>
        <div class="col-xxl-6">
            <div class="row justify-content-center">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle border-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="/pages/instructors" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-25.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/pages/instructors" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-26.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/pages/instructors" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-27.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/pages/instructors" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/user-28.jpg" class="wh-44 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    ...
                                    <tr>
                                        <td class="pt-1">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex">
                                                        <a href="/pages/my-profile">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-30.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-31.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-32.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                    </div>
                                                </div>
                                                <a href="/pages/project-list" class="flex-grow-1 ms-2 position-relative top-2">
                                        ...
                                        <td class="text-end pt-1">
                                            <a href="/pages/project-list" class="wh-35 d-inline-block border text-center lh-35 rounded-circle text-decoration-none hover-bg">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex">
                                                        <a href="/pages/my-profile">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-33.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-34.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-35.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                    </div>
                                                </div>
                                                <a href="/pages/project-list" class="flex-grow-1 ms-2 position-relative top-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex">
                                                        <a href="/pages/my-profile">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-36.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-37.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-38.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                    </div>
                                                </div>
                                                <a href="/pages/project-list" class="flex-grow-1 ms-2 position-relative top-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex">
                                                        <a href="/pages/my-profile">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-39.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-40.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-41.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                    </div>
                                                </div>
                                                <a href="/pages/project-list" class="flex-grow-1 ms-2 position-relative top-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex">
                                                        <a href="/pages/my-profile">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-25.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-28.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                                                        <a href="/pages/my-profile" class="ms-m-20">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-31.jpg" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                        </a>
                ...
                <div class="card-body p-4">
                    ...
                    <ul class="ps-0 mb-0 list-unstyled sales_by_locations mt-4">
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?= Yii::$app->request->baseUrl ?>/images/usa.svg" class="wh-30 rounded-circle" alt="usa">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?= Yii::$app->request->baseUrl ?>/images/germany.svg" class="wh-30 rounded-circle" alt="germany">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?= Yii::$app->request->baseUrl ?>/images/united-kingdom.svg" class="wh-30 rounded-circle" alt="united-kingdom">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?= Yii::$app->request->baseUrl ?>/images/canada.svg" class="wh-30 rounded-circle" alt="canada">
                            </div>
                            <div class="flex-grow-1 ms-3">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/course-details">Cybersecurity Awareness</a>
                                </td>
                                <td>Technology</td>
                                <td>
                                    <a href="/pages/instructors" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-42.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/course-details">Python Programming</a>
                                </td>
                                <td>Science</td>
                                <td>
                                    <a href="/pages/instructors" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-43.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/course-details">Big Data Analytics</a>
                                </td>
                                <td>Health and Wellness</td>
                                <td>
                                    <a href="/pages/instructors" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-44.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/course-details">Introduction to Blockchain</a>
                                </td>
                                <td>Education</td>
                                <td>
                                    <a href="/pages/instructors" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-45.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/course-details">Network Administration</a>
                                </td>
                                <td>Food and Cooking</td>
                                <td>
                                    <a href="/pages/instructors" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-46.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/pages/course-details">Artificial Intelligence</a>
                                </td>
                                <td>Lifestyle and Fashion</td>
                                <td>
                                    <a href="/pages/instructors" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/user-47.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                    ...
                    <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination mb-0 justify-content-center">
                                ...
                                <li class="page-item"><a class="page-link active" href="/dashboard/lms">1</a></li>
                                <li class="page-item"><a class="page-link" href="/dashboard/lms">2</a></li>
                                <li class="page-item"><a class="page-link" href="/dashboard/lms">3</a></li>
                                <li class="page-item"><a class="page-link" href="/dashboard/lms">4</a></li>
                                <li class="page-item">
                                    <a class="page-link icon" href="/dashboard/lms" aria-label="Next">
                                        <i class="material-symbols-outlined">keyboard_arrow_right</i>
                                    </a>
                        ...
                        <div class="card bg-card-bg-c bg-primary border-0 rounded-3 mb-4 overflow-hidden position-relative">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-center py-3">
                                    <div class="flex-shrink-0">
                                        <img src="<?= Yii::$app->request->baseUrl ?>/images/courses-1.jpg" class="wh-130-113 rounded-3" alt="courses">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                ...
                                <div class="text-end">
                                    <a href="/pages/course-details" class="btn border-color-white text-white py-1 px-2 px-sm-4 fs-14 fw-medium rounded-3 hover-bg">
                            ...
                            <img src="<?= Yii::$app->request->baseUrl ?>/images/shape.png" class="position-absolute top-0 end-0" alt="shape">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="card bg-card-bg-c bg-primary border-0 rounded-3 mb-4 overflow-hidden position-relative">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-center py-3">
                                    <div class="flex-shrink-0">
                                        <img src="<?= Yii::$app->request->baseUrl ?>/images/event-5.jpg" class="wh-130-113 rounded-3" alt="courses">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
