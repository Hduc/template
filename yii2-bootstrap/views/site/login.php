...
$this->title = 'Login | Trezo - Yii2 & Bootstrap 5 Admin Dashboard Template';
?>
        ...
        <div class="m-auto m-1230">
            <div class="row align-items-center">
                <div class="col-lg-6 d-none d-lg-block">
                    <img src="<?= Yii::$app->request->baseUrl ?>/images/login.jpg" class="rounded-3" alt="login">
                </div>
                <div class="col-lg-6">
                    <div class="mw-480 ms-lg-auto">
                        <div class="d-inline-block mb-4">
                            <img src="<?= Yii::$app->request->baseUrl ?>/images/logo.svg" class="rounded-3 for-light-logo" alt="login">
                            <img src="<?= Yii::$app->request->baseUrl ?>/images/white-logo.svg" class="rounded-3 for-dark-logo" alt="login">
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-sm-4">
                                <a href="https://www.google.com/" target="_blank" class="btn btn-outline-secondary bg-transparent w-100 py-2 hover-bg mb-4" style="border-color: #D6DAE1;">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/google.svg" alt="google">
                                </a>
                            </div>
                            <div class="col-lg-4 col-sm-4">
                                <a href="https://www.facebook.com/" target="_blank" class="btn btn-outline-secondary bg-transparent w-100 py-2 hover-bg mb-4" style="border-color: #D6DAE1;">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/facebook2.svg" alt="facebook2">
                                </a>
                            </div>
                            <div class="col-lg-4 col-sm-4">
                                <a href="https://www.apple.com/" target="_blank" class="btn btn-outline-secondary bg-transparent w-100 py-2 hover-bg mb-4" style="border-color: #D6DAE1;">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/apple.svg" alt="apple">
                                </a>
                            </div>
                        </div>
                        <form>
                            ...
                            <div class="form-group mb-4">
                                <a href="/forget-password" class="text-decoration-none text-primary fw-semibold">Forgot Password?</a>
                            </div>
                            <div class="form-group mb-4">
                                <a href="/" class="btn btn-primary fw-medium py-2 px-3 w-100">
