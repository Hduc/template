...
$this->title = 'Home | Trezo - Yii2 & Bootstrap 5 Admin Dashboard Template';
?>
...
<div class="banner-area bg-img pb-0" id="home">
    <div class="container position-relative z-1">
        <div class="banner-content text-center pb-75">
            ...
            <a href="contact" class="btn btn-primary py-2 px-4 fs-16 fw-medium rounded-3">
                <i class="ri-user-line fs-18"></i>
                <span class="ms-1">Get started - It is free</span>
            </a>
        </div>
        <div class="banner-img-wrap text-center">
            <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/banner-img.png" alt="banner-img">
        </div>

        <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/shape-3.png" class="shape shape-7" alt="shape">
        <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/shape-4.png" class="shape shape-8" alt="shape">
        <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/shape-5.png" class="shape shape-9" alt="shape">
        <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/shape-6.png" class="shape shape-10" alt="shape">
    </div>
</div>
...
<div class="tailor-area position-relative z-1">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="tailor-img">
                    <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/tailor-img.png" alt="tailor">
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/shape-1.png" class="shape shape-1" alt="shape">
    <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/shape-2.png" class="shape shape-2" alt="shape">
</div>
        ...
        <div class="masonrow">
            <div class="item">
                <div class="single-testimonials">
                    ...
                    <div class="d-flex align-items-center review-info">
                        <div class="review">
                            <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/testimonial-1.jpg" class="rounded-circle wh-50" alt="testimonial">
                        </div>
                        <div class="ms-3">
            ...
            <div class="item">
                <div class="single-testimonials">
                    ...
                    <div class="d-flex align-items-center review-info">
                        <div class="review">
                            <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/testimonial-2.jpg" class="rounded-circle wh-50" alt="testimonial">
                        </div>
                        <div class="ms-3">
                            <h4>John Smith</h4>
            ...
            <div class="item">
                <div class="single-testimonials">
                    ...
                    <div class="d-flex align-items-center review-info">
                        <div class="review">
                            <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/testimonial-3.jpg" class="rounded-circle wh-50" alt="testimonial">
                        </div>
                        <div class="ms-3">
            ...
            <div class="item">
                <div class="single-testimonials">
                    ...
                    <div class="d-flex align-items-center review-info">
                        <div class="review">
                            <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/testimonial-4.jpg" class="rounded-circle wh-50" alt="testimonial">
                        </div>
                        <div class="ms-3">
                            <h4>Kevin Brown</h4>
            ...
            <div class="item">
                <div class="single-testimonials">
                    ...
                    <div class="d-flex align-items-center review-info">
                        <div class="review">
                            <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/testimonial-5.jpg" class="rounded-circle wh-50" alt="testimonial">
                        </div>
                        <div class="ms-3">
                            <h4>Olivia Adams</h4>
            ...
            <div class="item">
                <div class="single-testimonials">
                    ...
                    <div class="d-flex align-items-center review-info">
                        <div class="review">
                            <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/testimonial-6.jpg" class="rounded-circle wh-50" alt="testimonial">
                        </div>
                        <div class="ms-3">
                            <h4>Daniel Lee</h4>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="contact-us-img mb-4 mb-lg-0">
                    <img src="<?= Yii::$app->request->baseUrl ?>/images/landing/contact-us.jpg" alt="contact-us">
                </div>
            </div>
            <div class="col-lg-6">
