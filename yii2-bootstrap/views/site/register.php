...
$this->title = 'Register | Trezo - Yii2 & Bootstrap 5 Admin Dashboard Template';
?>
        ...
        <div class="m-auto m-1230">
            <div class="row align-items-center">
                <div class="col-lg-6 d-none d-lg-block">
                    <img src="<?= Yii::$app->request->baseUrl ?>/images/register.jpg" class="rounded-3" alt="register">
                </div>
                <div class="col-lg-6">
                    <div class="mw-480 ms-lg-auto">
                        ...
                        <form>
                            ...
                            <div class="form-group mb-3">
                                <a href="/profile" class="btn btn-primary fw-medium py-2 px-3 w-100">
