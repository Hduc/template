...
<svelte:head>
	<title>Contacts | Trezo - Svelte & Bootsrap 5 Admin Dashboard Template</title>
</svelte:head>

<BreadCrumb page="Contacts List" category="APPS" parentLink="/dashboard" />
				...
				>
					...
					<nav aria-label="Page navigation example">
						<ul class="pagination mb-0 justify-content-center">
							<li class="page-item">
								<a class="page-link icon" href="/dashboard/apps/contacts" aria-label="Previous">
									<i class="material-symbols-outlined">keyboard_arrow_left</i>
								</a>
							</li>
							<li class="page-item">
								<a class="page-link active" href="/dashboard/apps/contacts">1</a>
							</li>
							<li class="page-item"><a class="page-link" href="/dashboard/apps/contacts">2</a></li>
							<li class="page-item"><a class="page-link" href="/dashboard/apps/contacts">3</a></li>
							<li class="page-item"><a class="page-link" href="/dashboard/apps/contacts">4</a></li>
							<li class="page-item">
								<a class="page-link icon" href="/dashboard/apps/contacts" aria-label="Next">
