...
<div class={`faq-arae position-relative z-1 pt-125 ${className}`} id="fqss">
	<div class="container">
			...
			<div class="accordion-item mb-3 border-0 bg-white">
				...
				>
					<div class="accordion-body">
						<p>
							Trezo is a comprehensive project management software designed to help teams streamline
							their workflow, collaborate effectively, and achieve project success.
						</p>
					</div>
				</div>
			</div>
