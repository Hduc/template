			...
			<div class="col-lg-3 col-sm-6">
				<div class="footer-single-item mb-4">
					...
					<p class="mb-4 pb-lg-2">
						With customizable dashboards tailored to your needs, collaborate effortlessly with your
						team and stay ahead with real-time updates.
					</p>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="footer-single-item mb-4 ms-lg-5 ps-lg-5">
					...
					<ul class="ps-0 mb-0 list-unstyled">
						<li class="mb-2 pb-1">
							<a href="/dahsboard" class="text-decoration-none">Trezo Dashboard</a>
						</li>
						<li class="mb-2 pb-1">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="footer-single-item mb-4 ms-lg-5 ps-lg-4">
					...
					<ul class="ps-0 mb-0 list-unstyled">
						...
						<li class="mb-2 pb-1">
							<a href="/faqs" class="text-decoration-none">Testimonials</a>
						</li>
						<li class="mb-0">
