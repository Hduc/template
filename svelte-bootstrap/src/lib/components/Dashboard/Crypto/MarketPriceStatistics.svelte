	...
	<div class="card border bg-white rounded-3 mb-4 p-0">
		...
		>
			...
			<div class="d-flex flex-wrap gap-2 align-items-center">
				<div>
					<ul class="analytics-tabs d-flex flex-wrap list-unstyled ps-0 mb-0">
						<li>
							<button>1H</button>
						</li>
						<li>
						...
						<div class="d-flex align-items-center">
							...
							<div class="flex-grow-1 ms-2">
								<span class="mb-1 d-block fw-medium text-secondary"
									>BITCOIN <span class="text-body fw-normal">(BTC)</span></span
								>
								<div class="d-flex">
		...
		<div class="p-4 pt-0" style="margin: -9px 0 -20px -18px;">
			<div id="market_price_statistics" bind:this={chartContainer}></div>
		</div>
	</div>
</div>
