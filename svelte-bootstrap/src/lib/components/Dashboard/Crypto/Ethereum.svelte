...
<div class="swiper-slide">
	<div class="border-0 rounded-3 mb-4 bg-primary-div bg-opacity-10 p-4">
		<div class="d-flex align-items-center">
			...
			<div class="flex-grow-1 ms-2">
				<span class="mb-1 d-block fw-medium text-secondary"
					>ETHEREUM <span class="text-body fw-normal">(BTC)</span></span
				>
				<div class="d-flex">
					<h3 class="mb-0 fs-20 fw-semibold me-1">$1,750</h3>
					<i class="material-symbols-outlined fs-16 position-relative top-3 text-danger"
						>trending_down</i
					>
		...
		<div
			...
			style="margin: -11px 0; max-width: 325px; margin: auto;"
		></div>
