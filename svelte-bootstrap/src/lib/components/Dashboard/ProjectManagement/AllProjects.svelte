				...
				>
					...
					<nav aria-label="Page navigation example">
						<ul class="pagination mb-0 justify-content-center">
							...
							<li class="page-item">
								<a class="page-link active" href="/dashboard/project-management">1</a>
							</li>
							<li class="page-item">
								<a class="page-link" href="/dashboard/project-management">2</a>
							</li>
							<li class="page-item">
								<a class="page-link" href="/dashboard/project-management">3</a>
							</li>
							<li class="page-item">
								<a class="page-link" href="/dashboard/project-management">4</a>
							</li>
							<li class="page-item">
