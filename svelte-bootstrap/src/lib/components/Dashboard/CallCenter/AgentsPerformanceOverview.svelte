			...
			<div class="col-sm-4">
				<div class="d-flex align-items-center">
					<div class="flex-shrink-0 position-relative z-1">
						<img src="/assets/images/user-161.png" class="rounded-2" alt="user" />
						<span
					...
					<tbody>
						<tr>
							<td>
								<div class="d-flex align-items-center">
									<div class="flex-shrink-0 position-relative z-1">
										<img src="/assets/images/user-162.png" class="rounded-2" alt="user" />
										<span
											class="bg-success rounded-circle d-inline-block position-absolute top-50 start-100 translate-middle"
											style="width: 8px; height: 8px;"
										></span>
						...
						<tr>
							<td>
								<div class="d-flex align-items-center">
									<div class="flex-shrink-0 position-relative z-1">
										<img src="/assets/images/user-163.png" class="rounded-2" alt="user" />
										<span
						...
						<tr>
							<td>
								<div class="d-flex align-items-center">
									<div class="flex-shrink-0 position-relative z-1">
										<img src="/assets/images/user-164.png" class="rounded-2" alt="user" />
										<span
											class="bg-success rounded-circle d-inline-block position-absolute top-50 start-100 translate-middle"
											style="width: 8px; height: 8px;"
										></span>
						...
						<tr>
							<td>
								<div class="d-flex align-items-center">
									<div class="flex-shrink-0 position-relative z-1">
										<img src="/assets/images/user-165.png" class="rounded-2" alt="user" />
										<span
											class="bg-danger rounded-circle d-inline-block position-absolute top-50 start-100 translate-middle"
											style="width: 8px; height: 8px;"
										></span>
