...
<div class="card bg-white border-0 rounded-3 mb-4">
	<div class="card-body p-4">
		...
		<div class="row align-items-center">
			<div class="col-sm-5">
				<div bind:this={chartContainer} id="device_sessions"></div>
			</div>
			<div class="col-sm-7">
				<ul class="ps-0 mb-0 list-unstyled ms-plus-21 border-top pt-1">
					<li class="d-flex justify-content-between align-items-center border-bottom pb-1 mb-1">
						<div class="d-flex align-items-center">
							<span
								class="d-inline-block bg-success rounded-circle"
		...
		<p class="fs-12 lh-16 mt-3 pt-2">
			This data helps you understand which devices are most commonly used and how engagement metrics
			vary between them.
		</p>
	</div>
</div>
