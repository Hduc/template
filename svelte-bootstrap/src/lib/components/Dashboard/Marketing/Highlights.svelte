		...
		<ul class="ps-0 mb-0 list-unstyled">
			...
			>
				...
				<span style="color: #463938;"
					><i class="ri-arrow-up-line text-success fs-16"></i> 4.9/5.0</span
				>
			</li>
			<li
				class="d-flex justify-content-between border-bottom pb-3 mb-3"
			...
			>
				...
				<span style="color: #463938;"
					><i class="ri-arrow-down-line text-danger fs-16"></i> 630K</span
				>
			</li>
			<li
				class="d-flex justify-content-between border-bottom pb-3 mb-3"
			...
			<li class="d-flex justify-content-between">
				...
				<span style="color: #463938;"
					><i class="ri-arrow-up-line text-success fs-16"></i> $3.58</span
				>
			</li>
		</ul>
	</div>
