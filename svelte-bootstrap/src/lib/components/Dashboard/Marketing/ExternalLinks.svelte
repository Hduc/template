		...
		<div class="card-body p-4">
			...
			<ul class="ps-0 mb-0 list-unstyled">
				<li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
					...
					<a href="/dashboard/marketing" class="text-decoration-none" aria-label="google">
				...
				<li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
					...
					<a href="/dashboard/marketing" class="text-decoration-none" aria-label="instagram">
						<i class="ri-external-link-line fs-20"></i>
					</a>
				</li>
				<li class="d-flex justify-content-between align-items-center">
					...
					<a href="/dashboard/marketing" class="text-decoration-none" aria-label="facebook">
						<i class="ri-external-link-line fs-20"></i>
					</a>
				</li>
			</ul>
