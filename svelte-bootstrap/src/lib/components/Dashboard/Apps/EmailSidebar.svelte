<div class="col-xl-4 col-lg-3 col-md-4">
	<div class="card bg-white border-0 rounded-3 mb-4">
		<div class="card-body p-4">
			...
			<a
				href="/dashboard/apps/email/compose"
			...
			<ul class="ps-0 mb-4 list-unstyled">
				<li class="mb-3 pb-1 d-flex justify-content-between align-items-center">
					<a
						href="/dashboard/apps/email/inbox"
						class="d-flex align-items-center text-decoration-none"
					>
						<i class="material-symbols-outlined fs-18 position-relative top-1 me-2 text-primary"
							>inbox</i
						>
				...
				<li class="mb-3 pb-1">
					<a
						href="/dashboard/apps/email/starred"
						class="d-flex align-items-center text-decoration-none"
					>
				...
				<li class="mb-3 pb-1">
					<a
						href="/dashboard/apps/email/snoozed"
						class="d-flex align-items-center text-decoration-none"
					>
				...
				<li class="mb-3 pb-1">
					<a
						href="/dashboard/apps/email/sent-mail"
						class="d-flex align-items-center text-decoration-none"
					>
				...
				<li class="mb-3 pb-1">
					<a
						href="/dashboard/apps/email/draft"
						class="d-flex align-items-center text-decoration-none"
					>
				...
				<li class="mb-3 pb-1">
					<a
						href="/dashboard/apps/email/important"
						class="d-flex align-items-center text-decoration-none"
					>
				...
				<li class="mb-3 pb-1">
					<a href="/dashboard/apps/chat" class="d-flex align-items-center text-decoration-none">
						<i class="material-symbols-outlined fs-18 position-relative top-1 me-2"
							>auto_read_pause</i
						>
				...
				<li class="mb-3 pb-1">
					<a
						href="/dashboard/apps/email/spam"
						class="d-flex align-items-center text-decoration-none"
					>
				...
				<li class="mb-3 pb-1">
					<a
						href="/dashboard/apps/email/trash-email"
						class="d-flex align-items-center text-decoration-none"
					>
