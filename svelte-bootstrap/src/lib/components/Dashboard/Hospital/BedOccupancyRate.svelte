			...
			<div class="row align-items-center">
				<div class="col-sm-6">
					<div class="d-flex align-items-center welcome-status-item mb-4">
						<div class="flex-shrink-0">
							<i class="material-symbols-outlined icon-bg bg-primary bg-opacity-25 text-primary"
								>airplay</i
							>
						</div>
					...
					<div class="d-flex align-items-center welcome-status-item mb-0">
						<div class="flex-shrink-0">
							<i class="material-symbols-outlined icon-bg bg-success bg-opacity-25 text-success"
				...
				<div class="col-sm-6 mt-3 mt-sm-0">
					<div class="text-center" style="margin-top: -8px;">
						<!-- Chart DOM container -->
						<div id="bed_occupancy_rate" bind:this={chartContainer}></div>
