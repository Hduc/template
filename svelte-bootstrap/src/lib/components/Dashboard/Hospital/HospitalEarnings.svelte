					...
					<div class="row">
						<div class="col-sm-6">
							<div class="card bg-white p-4 border-0 rounded-3 mb-4 exchange-for-dark">
								...
								<p class="fs-12 mb-0">
									Total Profit <span class="text-danger ms-1">
										<i class="ri-arrow-down-fill"></i>5%</span
									>
								</p>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="card bg-white p-4 border-0 rounded-3 mb-4 exchange-for-dark">
								...
								<p class="fs-12 mb-0">
									Total Costs <span class="text-success ms-1">
										<i class="ri-arrow-up-fill"></i>3%</span
									>
								</p>
							</div>
						</div>
								...
								<div class="card bg-white p-4 border-0 rounded-3 mb-0 exchange-for-dark">
									<div class="row align-items-center">
										<div class="col-lg-7">
											...
											<p class="fs-12 mb-0">
												Total Earnings <span class="text-success ms-1">
													<i class="ri-arrow-up-fill"></i>3%</span
												>
											</p>
										</div>
										<div class="col-lg-5">
											<div style="margin: -30px -10px -30px 0;">
												<!-- Chart Container -->
												<div id="total_earnings" bind:this={chartContainer}></div>
											</div>
										</div>
									</div>
								</div>
