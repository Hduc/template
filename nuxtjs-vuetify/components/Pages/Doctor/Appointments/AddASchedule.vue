<template>
  <v-dialog max-width="550">
    <template v-slot:activator="{ props: activatorProps }">
      <button v-bind="activatorProps" class="add-new-card-btn">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="trezo-form-group">
                ...
                <v-text-field type="date" class="date-input"> </v-text-field>
              </div>
            </div>
            <div class="col-md-6">
              <div class="trezo-form-group">
                ...
                <v-text-field type="time" class="date-input"> </v-text-field>
              </div>
            </div>
            <div class="col-md-6">
              <div class="trezo-form-group">
            ...
            <div class="col-md-12">
              <div class="trezo-form-group">
                ...
                <v-text-field placeholder="09:05 AM" required></v-text-field>
              </div>
            </div>
            <div class="col-md-12">
              <div class="trezo-form-group">
