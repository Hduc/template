<template>
  <v-card
    class="facebook-followers-card trezo-card border-radius d-block bg-white border-0 shadow-none"
  >
    <div class="trezo-card-content">
      <v-img src="@/assets/images/icons/facebook4.svg" alt="facebook" />
      <h3 class="fw-medium">98.5k</h3>
