<template>
  <v-card
    class="facebook-campaign-card trezo-card border-radius d-block bg-white border-0 shadow-none"
  >
    <div class="v-card-header">
      <div class="header-title">
        <h5 class="mb-0">Facebook Campaign Overview</h5>
...
export default defineComponent({
  ...
  setup() {
    ...
    const selectTimeframe = (
      timeframe: "This Day" | "This Week" | "This Month" | "This Year"
    ) => {
