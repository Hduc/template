<template>
  <v-card
    class="trades-per-month-card trezo-card mb-25 border-radius d-block bg-white shadow-none"
  >
    <div class="v-card-header">
      <h5 class="mb-0">Trades Per Month</h5>
    </div>
