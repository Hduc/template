...
const CourseCard: React.FC<{ course: Course }> = ({ course }) => {
  return (
    <div className="bg-white dark:bg-[#0a0e19] rounded-[15px] p-[20px] md:p-[25px] lg:p-[30px] 2xl:p-[35px]">
      <Link
        href={`${course.slug}`}
...
const PopularCourses: React.FC<PopularCoursesProps> = ({ customData }) => {
  // Use provided data or default to the coursesData
  const displayData = customData || coursesData;

  return (
    <>
      <div className="bg-[#f6f5f3] dark:bg-[#0e1321] py-[70px] md:py-[90px] lg:py-[110px] xl:py-[150px] 2xl:py-[180px]">
        <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
          ...
          <div className="text-center mt-[35px] md:mt-[50px] lg:mt-[70px]">
            <Link
              href="/courses"
