  ...
  return (
    <>
      <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
        <div className="h-px w-full bg-orange-100 dark:bg-gray-900"></div>
      </div>

      <div className="relative z-[1] py-[70px] md:py-[90px] lg:py-[110px] xl:py-[140px] dark:bg-[#0a0e19]">
        <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
            ...
            <div className="ltr:xl:-mr-[35px] rtl:xl:-ml-[35px]">
              ...
              <div className="mt-[20px] md:mt-[35px]">
                <a
                  ...
                  target="_blank"
                  className="inline-block leading-none text-[20px] text-orange-600 transition-all hover:text-orange-400 ltr:mr-[8px] rtl:ml-[8px] ltr:last:mr-0 rtl:last:ml-0"
                >
            ...
            <div className="ltr:xl:pl-[130px] rtl:xl:pr-[130px]">
              ...
              <ul>
                <li className="mb-[10px] last:mb-0">
                  <Link
                    href="/"
                    className="lg:text-[15px] xl:text-[16px] inline-block text-gray-500 dark:text-gray-400 transition-all hover:text-orange-600"
                  >
                    Home
                  </Link>
                </li>
              ...
              <ul>
                <li className="lg:text-[15px] xl:text-[16px] text-gray-500 dark:text-gray-400 mb-[10px] last:mb-0">
                  ...
                  <a
                    ...
                    className="text-orange-500 hover:text-orange-800 transition-all"
                  >
                    support@trezo.com
                  </a>
                </li>
        ...
        <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:gap-[25px]">
            <div className="text-center ltr:lg:text-left rtl:lg:text-right">
              <p className="!leading-[1.6]">
                ...
                <a
                  ...
                  target="_blank"
                  className="text-orange-500 transition-all hover:underline"
                >
                  EnvyTheme
                </a>
              </p>
            ...
            <div className="text-center lg:flex items-center justify-end gap-[15px]">
              <Link
                href="#"
                className="transition-all hover:text-orange-500 inline-block mt-[10px] lg:mt-0 mx-[7px] lg:mx-0"
              >
                Terms of Service
              </Link>
