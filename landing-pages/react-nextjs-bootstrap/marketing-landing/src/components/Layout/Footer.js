  ...
  return (
    <>
      <Container className="cmw-1308">
        <div className="border-bottom border-card-text-c"></div>
      </Container>

      <div
        className="footer-area with-marketing-footer ptb-180 ptb-140"
        style={{
      ...
      <div className="copyright-area-ecommerce with-marketing-copyright">
        <Container className="cmw-1308">
          <div className="d-flex flex-wrap gap-2 justify-content-center justify-content-md-between align-items-center">
            <p className="fs-14 mb-0">
              ...
              <a
                ...
                target="_blank"
                className="text-decoration-none text-danger-50"
              >
                EnvyTheme
              </a>
            </p>
