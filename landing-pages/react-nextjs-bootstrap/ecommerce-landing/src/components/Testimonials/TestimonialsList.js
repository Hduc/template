...
const TestimonialsList = () => {
        ...
        const data = {
          ...
          testimonials: [
            ...
            },
            {
              ...
              rating: 5,
              content:
                "Trezo simplified everything for us — from analytics to marketing. We saw a 30% increase in revenue in just 2 months. Super easy to use!",
              author: {
                name: "Priya M.",
            ...
            },
            {
              ...
              rating: 5,
              content:
                "Switching to Trezo was the best decision. The platform is intuitive and powerful. We finally have real insights into our customer base.",
              author: {
                name: "Leo G.",
                role: "Online Electronics Store",
            ...
            },
            {
              ...
              rating: 5,
              content:
                "I run two stores and Trezo helps me keep everything organized. The integration with Shopify is seamless and the reporting is excellent.",
              author: {
                name: "Sofia L.",
  ...
  return (
    <>
      <div className="testimonials-area position-relative z-2 ptb-180">
        <Container className="cmw-1308">
          <div className="section-title2 mx-auto text-center">
            <span className="top-title2">Customer Testimonials</span>
            <h2>What Store Owners Say About Trezo</h2>
            <p>
