...
@Component({
    ...
    imports: [MatCardModule, MatDatepickerModule, MatButtonModule, MatFormFieldModule, MatInputModule, MatNativeDateModule, FileUploadModule, NgxMaterialTimepickerModule, MatSelectModule],
