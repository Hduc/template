                            ...
                            <div class="max-h-497" data-simplebar>
                                ...
                                <ul class="ps-0 mb-4 list-unstyled chat-list">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom border-color-gray pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-49.jpg" class="wh-48 rounded-circle" alt="user">
                                                <div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-50.jpg" class="wh-45 rounded-circle" alt="user">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-51.jpg" class="wh-45 rounded-circle" alt="user">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-52.jpg" class="wh-45 rounded-circle" alt="user">
                                                <div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                                <h4 class="fs-16 fw-semibold mb-1">David Martinez</h4>
                                ...
                                <ul class="ps-0 mb-0 list-unstyled chat-list">
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-53.jpg" class="wh-45 rounded-circle" alt="user">
                                                <div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-54.jpg" class="wh-45 rounded-circle" alt="user">
                                                <div class="position-absolute p-1 bg-danger border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-55.jpg" class="wh-45 rounded-circle" alt="user">
                                                <div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-56.jpg" class="wh-45 rounded-circle" alt="user">
                                                <div class="position-absolute p-1 bg-danger border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-57.jpg" class="wh-45 rounded-circle" alt="user">
                                                <div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-58.jpg" class="wh-45 rounded-circle" alt="user">
                                                <div class="position-absolute p-1 bg-danger border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/user-59.jpg" class="wh-45 rounded-circle" alt="user">
                                                <div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                            ...
                            <div class="max-h-497" data-simplebar>
                                ...
                                <ul class="ps-0 mb-4 list-unstyled chat-list">
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/wordpress.png" class="wh-45 rounded-circle" alt="wordpress">
                                                <div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom border-color-gray pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/html.png" class="wh-48 rounded-circle" alt="html">
                                                <div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/question-and-answer.png" class="wh-45 rounded-circle" alt="question-and-answer">
                                                <div class="position-absolute p-1 bg-warning border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                    ...
                                    <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 cursor">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="/img/social-media.png" class="wh-45 rounded-circle" alt="social-media">
                                                <div class="position-absolute p-1 bg-danger border border-2 border-white rounded-circle status-position2"></div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap ga-2 border-bottom pb-4 mb-4">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 position-relative">
                                <img src="/img/user-49.jpg" class="wh-52 rounded-circle" alt="user">
                                <div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2"></div>
                            </div>
                            <div class="flex-grow-1 ms-2 ps-1 position-relative top-2">
                                <h4 class="fs-16 fw-semibold mb-1">Michael Johnson</h4>
