                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/project-overview" class="text-body">Hotel Management System</a>
                                </td>
                                <td>Shawn Kennedy</td>
                                <td class="text-body">30 Apr 2024</td>
                                <td class="text-body">High</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/project-overview" class="text-body">Send Proposal to APR Ltd</a>
                                </td>
                                <td>Roberto Cruz</td>
                                <td class="text-body">25 Apr 2024</td>
                                <td class="text-body">Low</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/project-overview" class="text-body">Python Upgrade</a>
                                </td>
                                <td>Juli Johnson</td>
                                <td class="text-body">20 Apr 2024</td>
                                <td class="text-body">Medium</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/project-overview" class="text-body">Schedule meeting with Trezo</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/project-overview" class="text-body">Engineering Lite Touch</a>
                                </td>
                                <td>Louis Nagle</td>
                                <td class="text-body">10 Apr 2024</td>
                                <td class="text-body">Low</td>
                    ...
                    <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination mb-0 justify-content-center">
                                <li class="page-item">
                                    <a class="page-link icon" href="/dashboard/to-do-list" aria-label="Previous">
                                        <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                    </a>
                                </li>
                                <li class="page-item"><a class="page-link active" href="/dashboard/to-do-list">1</a></li>
                                <li class="page-item"><a class="page-link" href="/dashboard/to-do-list">2</a></li>
                                <li class="page-item"><a class="page-link" href="/dashboard/to-do-list">3</a></li>
                                <li class="page-item"><a class="page-link" href="/dashboard/to-do-list">4</a></li>
                                <li class="page-item">
                                    <a class="page-link icon" href="/dashboard/to-do-list" aria-label="Next">
