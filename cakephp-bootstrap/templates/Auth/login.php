        ...
        <div class="m-auto m-1230">
            <div class="row align-items-center">
                <div class="col-lg-6 d-none d-lg-block">
                    <img src="/img/login.jpg" class="rounded-3" alt="login">
                </div>
                <div class="col-lg-6">
                    <div class="mw-480 ms-lg-auto">
                        ...
                        <form>
                            ...
                            <div class="form-group mb-4">
                                <a href="/auth/forget-password" class="text-decoration-none text-primary fw-semibold">Forgot Password?</a>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group">
                                <p>Don’t have an account. <a href="/auth/register" class="fw-medium text-primary text-decoration-none">Register</a></p>
                            </div>
                        </form>
                    </div>
                </div>
