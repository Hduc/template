        ...
        <div class="m-auto m-1230">
            <div class="row align-items-center">
                <div class="col-lg-6 d-none d-lg-block">
                    <img src="/img/register.jpg" class="rounded-3" alt="register">
                </div>
                <div class="col-lg-6">
                    <div class="mw-480 ms-lg-auto">
                        <div class="d-inline-block mb-4">
                            <img src="/img/logo.svg" class="rounded-3 for-light-logo" alt="login">
                            <img src="/img/white-logo.svg" class="rounded-3 for-dark-logo" alt="login">
                        </div>
                        ...
                        <form>
                            ...
                            <div class="form-group mb-3">
                                <a href="/dashboard/profile" class="btn btn-primary fw-medium py-2 px-3 w-100">
                            ...
                            <div class="form-group">
                                <p>By confirming your email, you agree to our <a href="/terms-conditions"class="fw-medium text-decoration-none">Terms of Service</a> and that you have read and understood our <a href="privacy-policy.html"class="fw-medium text-decoration-none">Privacy Policy</a>.</p>
                                <p>Already have an account. <a href="/auth/login" class="fw-medium text-primary text-decoration-none">Log In</a></p>
                            </div>
                        </form>
                    </div>
                </div>
