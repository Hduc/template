        ...
        <div class="m-auto m-1230">
            <div class="row align-items-center">
                <div class="col-lg-6 d-none d-lg-block">
                    <img src="/img/reset.jpg" class="rounded-3" alt="reset">
                </div>
                <div class="col-lg-6">
                    <div class="mw-480 ms-lg-auto">
                        ...
                        <p class="fw-medium fs-16 mb-4">Enter your new password and confirm it another time in the field below.</p>
                        <form>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="password" class="form-control" placeholder="Type your confirm password">
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group">
                                <p>Back to <a href="/auth/login" class="fw-medium text-primary text-decoration-none">Login</a></p>
                            </div>
                        </form>
                    </div>
                </div>
