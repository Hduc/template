...
<div class="page-banner-area" id="home">
    <div class="container position-relative z-1">
        <div class="banner-content text-center mb-0">
            <h1 class="fs-60 mb-0">Our Team</h1>
        </div>

        <img src="/img/landing/shape-5.png" class="shape-5" alt="shape">
        <img src="/img/landing/shape-6.png" class="shape-6" alt="shape">
    </div>
</div>
<!-- End Banner Area -->

<!-- End Our Team Area -->
<div class="our-team-area position-relative z-1 pt-150" id="ourteam">
    <div class="container">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="our-team-single-item">
                        <div class="team-img">
                            <img src="/img/landing/team-1.jpg" alt="team">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="our-team-single-item">
                        <div class="team-img">
                            <img src="/img/landing/team-2.jpg" alt="team">
                        </div>
                        <div class="team-content d-flex justify-content-between align-items-center">
                            <div>
                                <h3>Emily Davis</h3>
                ...
                <div class="swiper-slide">
                    <div class="our-team-single-item">
                        <div class="team-img">
                            <img src="/img/landing/team-3.jpg" alt="team">
                        </div>
                        <div class="team-content d-flex justify-content-between align-items-center">
                            <div>
                                <h3>Daniel Lee</h3>
    ...
    <img src="/img/landing/shape-1.png" class="shape shape-3" alt="shape">
    <img src="/img/landing/shape-2.png" class="shape shape-4" alt="shape">
</div>
<!-- End Our Team Area -->
...
<div class="unlock-area ptb-150 position-relative z-1" id="admin">
    ...
    <img src="/img/landing/shape-1.png" class="shape shape-5" alt="shape">
    <img src="/img/landing/shape-2.png" class="shape shape-6" alt="shape">
</div>
<!-- End Unlock Area -->