    ...
    <div class="row"> 
            ...
            <div class="card border-0 p-4 bg-white rounded-3 mb-4 position-relative">
                <div class="row">
                    ...
                    <div class="col-lg-3 d-none d-md-block">
                        <img src="/img/shape-2.png" class="position-absolute top-0 end-0 bottom-0 shape-2" alt="shape">
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xxl-4">
            <div class="card border-0 rounded-3 p-4 position-relative mb-4 realtime-for-dark" style="background-color: #4936F5 !important;">
                <img src="/img/shape-3.png" class="position-absolute top-0 end-0" alt="shape">
        ...
        <div class="col-xxl-7">
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="default-table-area style-two browser-leads browser-used">
                        <div class="table-responsive">
                            <table class="table align-middle border-0 for-mobile-width">
                                <thead>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/chrome.png" class="wh-16 rounded-circle" alt="chrome">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/safari.png" class="wh-16 rounded-circle" alt="safari">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/edge.png" class="wh-16 rounded-circle" alt="edge">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/firefox.png" class="wh-16 rounded-circle" alt="firefox">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/opera.png" class="wh-16 rounded-circle" alt="opera">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/other.png" class="wh-16 rounded-circle" alt="other">
                                                <div class="ms-2">
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 pb-4">
                        ...
                        <select class="form-select month-select form-control p-0 h-auto border-0 pe-4 w-auto" style="background-position: right 0 center; color: #64748B !important;" aria-label="Default select example">
                            <option>29/10/2024 - 05/11/2024</option>
                            <option value="1">10/11/2024 - 25/11/2024</option>
                            <option selected value="2">25/11/2024 - 25/12/2024</option>
                        </select>
                    </div>

                    <div class="default-table-area style-two browser-leads by-keywords">
                        <div class="table-responsive">
                        ...
                        <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap mt-4">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination mb-0 justify-content-center">
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/analytics" aria-label="Previous">
                                            <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                        </a>
                                    </li>
                                    <li class="page-item"><a class="page-link active" href="/dashboard/analytics">1</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/analytics">2</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/analytics">3</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/analytics">4</a></li>
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/analytics" aria-label="Next">
        ...
        <div class="col-xxl-7">
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="default-table-area style-two browser-leads pages-today">
                        <div class="table-responsive">
                            <table class="table align-middle border-0 for-mobile-width">
                                <thead>
                                    <tr class="border-bottom">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="fw-medium">
                                            <a href="/dashboard/analytics" class="text-primary">/dashboard-overview</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="fw-medium">
                                            <a href="/dashboard/analytics" class="text-primary">/custom-reports/generate</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="fw-medium">
                                            <a href="/dashboard/analytics" class="text-primary">/export-data</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="fw-medium">
                                            <a href="/dashboard/analytics" class="text-primary">/realtime-users</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="fw-medium">
                                            <a href="/dashboard/analytics" class="text-primary">/account-preferences</a>
                                        </td>
                                        <td class="fw-medium">Organic</td> 
                                    ...
                                    <tr>
                                        <td class="fw-medium">
                                            <a href="/dashboard/analytics" class="text-primary">/apis-and-reports</a>
                                        </td>
                                        <td class="fw-medium">Paid</td> 
                ...
                <div class="card-body p-4 pb-0">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="d-flex mb-4">
                                <div class="flex-shrink-0 position-relative top-1">
                                    <img src="/img/united-states-2.png" class="rounded-circle" style="width: 20px; height: 20px;" alt="united-states">
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex mb-4">
                                <div class="flex-shrink-0 position-relative top-1">
                                    <img src="/img/united-kingdom-2.png" class="rounded-circle" style="width: 20px; height: 20px;" alt="united-states">
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex mb-4">
                                <div class="flex-shrink-0 position-relative top-1">
                                    <img src="/img/canada-2.png" class="rounded-circle" style="width: 20px; height: 20px;" alt="canada">
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex mb-4">
                                <div class="flex-shrink-0 position-relative top-1">
                                    <img src="/img/australia.png" class="rounded-circle" style="width: 20px; height: 20px;" alt="australia">
                                </div>
                                <div class="flex-grow-1 ms-2">
