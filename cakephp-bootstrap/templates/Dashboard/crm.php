                ...
                <div class="card-body p-4">
                    ...
                    <ul class="ps-0 mb-0 list-unstyled border-top pt-3">
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="/img/user-6.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                            ...
                            <a href="/dashboard/my-profile" class="wh-35 d-inline-block border text-center lh-35 rounded-circle text-decoration-none hover-bg">
                        ...
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="/img/user-7.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    <h6 class="mb-0 fw-medium">Alex Davis</h6>
                                    <span>alex@trezo.com</span>
                        ...
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="/img/user-8.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    <h6 class="mb-0 fw-medium">Alex Davis</h6>
                                    <span>alex@trezo.com</span>
                        ...
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="/img/user-9.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    <h6 class="mb-0 fw-medium">Alex Davis</h6>
                                    <span>alex@trezo.com</span>
                        ...
                        <li class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="/img/user-10.jpg" class="wh-44 rounded-circle" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2 position-relative top-2">
                                    <h6 class="mb-0 fw-medium">Alex Davis</h6>
                                    <span>alex@trezo.com</span>
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-11.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-12.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-13.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-14.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-15.jpg" class="wh-44 rounded-circle" alt="user">
                                                <div class="ms-2">
                                                    <h6 class="fw-medium fs-14">David Brown</h6>
                                                </div>
                                            </a>
