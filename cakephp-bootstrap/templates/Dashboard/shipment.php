                        ...
                        <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap p-4">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination mb-0 justify-content-center">
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/shipment" aria-label="Previous">
                                            <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                        </a>
                                    </li>
                                    <li class="page-item"><a class="page-link active" href="/dashboard/shipment">1</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/shipment">2</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/shipment">3</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/shipment">4</a></li>
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/shipment" aria-label="Next">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mt-3">
                                        <img src="/img/united-states-2.png" class="rounded-circle" style="width: 16px;" alt="united-states">
                                        <span class="text-white ms-2">United States 85%</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mt-3">
                                        <img src="/img/germany-2.png" class="rounded-circle" style="width: 16px;" alt="germany">
                                        <span class="text-white ms-2">Germany 75%</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mt-3">
                                        <img src="/img/united-kingdom-2.png" class="rounded-circle" style="width: 16px;" alt="united-kingdom">
                                        <span class="text-white ms-2">United Kingdom 40%</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mt-3">
                                        <img src="/img/canada-2.png" class="rounded-circle" style="width: 16px;" alt="canada">
                                        <span class="text-white ms-2">Canada 10%</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mt-3">
                                        <img src="/img/portugal.svg" class="rounded-circle" style="width: 16px;" alt="portugal">
                                        <span class="text-white ms-2">Portugal 05%</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mt-3">
                                        <img src="/img/spain.svg" class="rounded-circle" style="width: 16px;" alt="spain">
                                        <span class="text-white ms-2">Spain 15%</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mt-3">
                                        <img src="/img/france.svg" class="rounded-circle" style="width: 16px;" alt="france">
                                        <span class="text-white ms-2">France 25%</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center mt-3">
                                        <img src="/img/australia.png" class="rounded-circle" style="width: 16px;" alt="australia">
                ...
                <div class="col-md-6 col-xxl-12">
                    <div class="card border-0 rounded-3 bg-white mb-4">
                        <div class="card-body p-4">
                            ...
                            <ul class="ps-0 mb-0 list-unstyled for-rtl-chat" style="height: 240px;" data-simplebar>
                                <li class="mb-3">
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-62.jpg" class="rounded-circle" style="width: 40px; height: 40px;" alt="user">
                                        </div>
                                ...
                                <li class="text-end">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-63.jpg" class="rounded-circle" style="width: 40px; height: 40px;" alt="user">
                                        </div>
                                    </div>
                                ...
                                <li class="mb-3">
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-64.jpg" class="rounded-circle" style="width: 40px; height: 40px;" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                ...
                                <li class="text-end">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-65.jpg" class="rounded-circle" style="width: 40px; height: 40px;" alt="user">
                                        </div>
                                    </div>
                                    <p class="bg-danger bg-opacity-10 p-2 rounded-2 ms-auto" style="max-width: 310px;">Almost! I just need to double-check some data. I’ll send it over in about an hour.</p>
                                </li>
                            ...
                            <form class="position-relative z-1 mt-3 for-rtl-form">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-1.jpg" class="wh-30 rounded-circle" alt="user">
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-2.jpg" class="wh-30 rounded-circle" alt="user">
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-3.jpg" class="wh-30 rounded-circle" alt="user">
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-4.jpg" class="wh-30 rounded-circle" alt="user">
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-5.jpg" class="wh-30 rounded-circle" alt="user">
                                        <div class="ms-2">
