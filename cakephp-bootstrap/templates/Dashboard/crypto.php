<div class="main-content-container overflow-hidden">
    <div
        class="border-0 p-4 pb-0 bg-white rounded-3 mb-4 without-card"
    >
        <div
            class="d-flex flex-wrap gap-2 justify-content-between mb-4"
        >
            <div>
            ...
            <div>
                <div
                    class="cryptocurrency-controller d-flex gap-1"
                >
        ...
        <div class="swiper cryptocurrency-slide">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div
                        class="border-0 rounded-3 mb-4 bg-primary bg-opacity-10 p-4"
                    >
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <span
                                    class="mb-1 d-block fw-medium text-secondary"
                                    >BITCOIN
                                    <span
                                ...
                                <div class="d-flex">
                                    <h3
                                        class="mb-0 fs-20 fw-semibold me-1"
                                    >
                                        $27,500
                                    </h3>
                                    <i
                        ...
                        >
                            <div>
                                <span
                                    class="fs-12 fw-medium d-block mb-1"
                                    >Market Cap:</span
                                >
                                <h4
                                    class="fs-12 fw-semibold mb-0"
                                >
                                    $520B
                                </h4>
                            </div>
                ...
                <div class="swiper-slide">
                    <div
                        class="border-0 rounded-3 mb-4 bg-primary-div bg-opacity-10 p-4"
                    >
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
                ...
                <div class="swiper-slide">
                    <div
                        class="border-0 rounded-3 mb-4 bg-danger bg-opacity-10 p-4"
                    >
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
                ...
                <div class="swiper-slide">
                    <div
                        class="border-0 rounded-3 mb-4 bg-success bg-opacity-10 p-4"
                    >
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
                ...
                <div class="swiper-slide">
                    <div
                        class="border-0 rounded-3 mb-4 bg-warning bg-opacity-10 p-4"
                    >
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img
        ...
        <div class="row">
            <div class="col-lg-8">
                <div
                    class="card border bg-white rounded-3 mb-4 p-0"
                >
                    <div
                        class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-4 border-bottom p-3 px-4"
                    >
                        <div>
                            <h3 class="mb-0">
                        ...
                        >
                            <div>
                                <ul
                                    class="analytics-tabs d-flex flex-wrap list-unstyled ps-0 mb-0"
                                >
                                    <li>
                                        <button>1H</button>
                                    </li>
                            ...
                            <div
                                class="dropdown action-opt m-sm-3"
                            >
                                <button
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        class="fs-14 fw-semibold text-secondary ms-1"
                                        >Bitcoin</span
                                    >
                                    <i
                        ...
                        <div class="row align-items-center">
                            <div class="col-xxl-8 col-sm-10">
                                ...
                                >
                                    ...
                                    <div>
                                        <span
                                            class="fs-14 fw-medium d-block mb-1"
                                            >Market Cap:</span
                                        >
                                        <h4
                            ...
                            <div class="col-xxl-4 col-sm-2">
                                <div
                                    class="d-flex justify-content-end mt-3 mt-sm-0"
                                >
                                    <div
                                        class="dropdown action-opt"
                                    >
                                        <button
                                            class="btn bg-transparent p-0"
                                            type="button"
            ...
            <div class="col-lg-4">
                ...
                >
                    ...
                    >
                        ...
                        <button
                            class="p-0 border-0 bg-transparent position-relative top-3"
                        >
                            <span
                    ...
                    <form class="p-4 pt-0">
                        <div class="mb-30">
                            ...
                            <div
                                class="dropdown action-opt mb-3"
                            >
                                <button
    ...
    <div class="row">
        <div class="col-xxl-7">
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <div
                        class="default-table-area style-two transaction-table"
                    >
                            ...
                            >
                                <thead>
                                    <tr class="border-bottom">
                                        ...
                                        <th
                                            scope="col"
                                            class="text-end bg-transparent pe-0"
                                        >
                                            Total Value
                                        </th>
                                    </tr>
                        ...
                        <div
                            class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap mt-4"
                        >
                            <span class="fs-12 fw-medium"
                                >Showing 7 of 30 Results</span
                            >
        ...
        <div class="col-xxl-5">
            <div
                class="card bg-primary p-4 border-0 position-relative z-1"
            >
                <div class="pb-4 mb-3">
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="flex-grow-1 ms-2">
                        <span
                            class="mb-1 d-block fw-medium text-white"
                            >TOTAL BALANCE</span
                        >
                        <div class="d-flex">
                            <h3
                                class="mb-0 fs-20 fw-semibold me-1 text-white"
                            >
                                $78,350.00
                            </h3>
                            <i
                ...
                <div
                    class="default-table-area style-two portfolio-table"
                >
                    <div class="table-responsive">
                        <table
                            class="table align-middle border-0"
                        >
                            <thead>
                                <tr class="border-bottom">
                                    ...
                                    <th
                                        scope="col"
                                        class="text-white text-end bg-transparent"
                                    >
                                        Amount
                                    </th>
                                    <th
                                        scope="col"
                                        class="text-white text-end bg-transparent pe-0"
                                    >
                                        Total Value
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td
                                        class="fw-medium ps-0 text-white"
                                    >
                                    ...
                                    <td
                                        class="text-end fw-medium text-white"
                                    >
                                        0.50 BTC
                                    </td>
                                    <td
                                        class="text-end fw-medium text-white pe-0"
                                    >
                                        $41,250
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td
                                        class="fw-medium text-white ps-0"
                                    >
                                        <span class="fw-medium"
                                            >Cardano
                                            <span
    ...
    <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
            ...
            <div
                class="default-table-area style-two rankings-table"
            >
                <div class="table-responsive">
                    <table class="table align-middle border-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td
                                    class="text-end fw-medium text-success"
                                >
                                    +2.3%
                                </td>
                                <td
                            ...
                            <tr>
                                ...
                                <td
                                    class="text-end fw-medium text-danger"
                                >
                                    -1.2%
                                </td>
                                <td
