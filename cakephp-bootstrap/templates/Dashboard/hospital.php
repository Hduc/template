    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            >
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        <div
                            class="col-lg-9 col-sm-6 col-xl-10 col-xxl-7"
                        >
                            <div style="padding-bottom: 35px">
                                <h3
                                    class="text-white fw-semibold mb-1 fs-20"
                                >
                                    Hi,
                                    <span style="color: #ffe8d4"
                                        >Dr. Olivia!</span
                                    >
                                </h3>
                                <p class="text-body-bg">
                                    Your schedule today
                                </p>
                            </div>

                            <div
                                class="d-flex align-items-center flex-wrap gap-3 gap-xxl-4"
                            >
                                <div
                                ...
                                >
                                    ...
                                    >
                                        <h5
                                            class="text-white fw-semibold mb-0 fs-18"
                                        >
                                            320
                                        </h5>
                                        <p class="text-light">
                        ...
                        <div
                            class="col-lg-3 col-sm-6 col-xl-2 col-xxl-5"
                        >
                            <div
                                class="welcome-img text-center text-sm-end mt-4 mt-sm-0"
                            >
                                <img
                                    src="/img/dr-olivia.png"
                                    alt="welcome"
                                />
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div
                        class="card bg-primary-div bg-opacity-25 border-0 rounded-3 p-4 mb-4 overflow-hidden"
                    >
                        <span
                            class="d-block mb-3"
                            style="color: #526077"
                            >Overall Visitors</span
                        >
                        <div class="d-flex align-items-center">
                            ...
                            <span
                                class="d-inline-block px-2 text-success border-success border rounded-pill bg-opacity-25 fs-12 fw-medium ms-2"
                                style="
                ...
                <div class="col-sm-6">
                    <div
                        class="card bg-danger bg-opacity-25 border-0 rounded-3 p-4 mb-4 overflow-hidden"
                    >
                        <span
                            class="d-block mb-3"
                            style="color: #526077"
                            >Patients last 7 days</span
                        >
                        <div class="d-flex align-items-center">
                            <h3 class="fs-24 fw-medium mb-0">
                                768
                            ...
                            <span
                                class="d-inline-block px-2 text-danger border-danger border rounded-pill bg-opacity-25 fs-12 fw-medium ms-2"
                                style="
                        ...
                        <div
                            style="
                                margin: -5px -19px -31px -32px;
                            "
                        >
                            <div
                                id="patients_last_7_days_service"
                            ></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <div style="margin: -5px -9px -28px -17px">
                        <div
                            id="patient_admissions_discharges"
                        ></div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-12 col-xxl-5">
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <div
                        style="margin: -36px -21px -63px -18px"
                    >
                        <div
                            id="emergency_room_visits"
                ...
                <div class="card-body p-4">
                    ...
                    >
                        <span
                            ...
                            class="bg-primary d-inline-block me-2"
                        ></span>
                        <span
                            >Cardiology:
                    ...
                    <div class="d-flex align-items-center mb-0">
                        <span
                            style="width: 12px; height: 2px"
                            class="bg-danger d-inline-block me-2"
                        ></span>
                        <span
                            >Orthopedics:
                            <span class="fw-semibold"
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div
                                class="d-flex align-items-center welcome-status-item mb-4"
                            >
                                <div class="flex-shrink-0">
                                    <i
                            ...
                            <div
                                class="d-flex align-items-center welcome-status-item mb-0"
                            >
                                <div class="flex-shrink-0">
                                    <i
                                        class="material-symbols-outlined icon-bg bg-success bg-opacity-25 text-success"
                                        >featured_seasonal_and_gifts</i
                                    >
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="mb-0 fs-18">
    ...
    <div class="row">
        <div class="col-lg-7 col-xl-8">
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <div
                        class="default-table-area style-two patient-table"
                    >
                            ...
                            >
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td
                                            class="text-end fw-medium text-body"
                                        >
                                            Sept 12, 2024
                                        </td>
                                        <td
        ...
        <div class="col-lg-5 col-xl-4">
            <div
                ...
                style="background-color: #7c24cc"
            >
                <div
                    class="card-body p-4 py-5 p-xl-5 text-center"
                >
                    <h2
                        class="text-white fs-24 fw-semibold mb-2"
                    >
                        Schedule Appointment
                    </h2>
                    <p
                        class="text-white fs-14 m-auto"
                        style="max-width: 273px"
                    >
                        Quickly schedule an appointment for a
                        patient with any available doctor
                    </p>
                    <div class="py-4 mb-1">
                        <img
                    ...
                    <button
                        class="btn btn-primary py-2 px-4 fs-16 fw-medium text-white"
                    >
                        Book Appointment
                    </button>
                </div>
            ...
            >
                <div class="card-body p-4">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div
                                class="hospital-img pt-3 pb-4 text-center"
                            >
                                <img
