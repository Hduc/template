    ...
    <div class="rounded-3 position-relative z-1 manage-nft" style="background: linear-gradient(92deg, #23272E 7.31%, #3F5272 97.89%); padding: 60px 40px 150px;">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center">
            <div class="flex-grow-1 me-3">
                <img src="/img/shape-8.png" class="position-absolute top-0 end-0" alt="shape">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="bg-white rounded-3 border-0 p-3 place-bid for-dark-card">
                        <a href="/dashboard/nft-details" class="d-block  mb-3 text-decoration-none position-relative">
                            <img src="/img/nft-1.gif" class="rounded-3" alt="nft">
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                            <a href="/dashboard/creator-details" class="d-flex align-items-center text-decoration-none">
                                <div class="flex-shrink-0">
                                    <img src="/img/user-76.gif" class="rounded-circle" style="width: 27px; height: 27px;" alt="user">
                                </div>
                            ...
                            <img src="/img/verify.svg" class="cursor" alt="verify" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Verified"> 
                        </div>

                        <div class="d-flex justify-content-between align-items-center">
                            <a href="/dashboard/nft-details" class="d-flex align-items-center text-decoration-none">
                ...
                <div class="swiper-slide">
                    <div class="bg-white rounded-3 border-0 p-3 place-bid for-dark-card">
                        <a href="/dashboard/nft-details" class="d-block mb-3 text-decoration-none position-relative">
                            <img src="/img/nft-2.png" class="rounded-3" alt="nft">
                            <span class="btn btn-primary py-2 px-3 d-inline-block fs-16 fw-medium position-absolute top-50 start-50 translate-middle opacity-0">
                                Place Bid
                            </span>
                        </a>
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                            <a href="/dashboard/creator-details" class="d-flex align-items-center text-decoration-none">
                                <div class="flex-shrink-0">
                                    <img src="/img/user-77.gif" class="rounded-circle" style="width: 27px; height: 27px;" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2">
                ...
                <div class="swiper-slide">
                    <div class="bg-white rounded-3 border-0 p-3 place-bid for-dark-card">
                        <a href="/dashboard/nft-details" class="d-block  mb-3 text-decoration-none position-relative">
                            <img src="/img/nft-3.gif" class="rounded-3" alt="nft">
                            <span class="btn btn-primary py-2 px-3 d-inline-block fs-16 fw-medium position-absolute top-50 start-50 translate-middle opacity-0">
                                Place Bid
                            </span>
                        </a>
                ...
                <div class="swiper-slide">
                    <div class="bg-white rounded-3 border-0 p-3 place-bid for-dark-card">
                        <a href="/dashboard/nft-details" class="d-block  mb-3 text-decoration-none position-relative">
                            <img src="/img/nft-4.gif" class="rounded-3" alt="nft">
                            <span class="btn btn-primary py-2 px-3 d-inline-block fs-16 fw-medium position-absolute top-50 start-50 translate-middle opacity-0">
                                Place Bid
                            </span>
                        </a>
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                            <a href="/dashboard/creator-details" class="d-flex align-items-center text-decoration-none">
                                <div class="flex-shrink-0">
                                    <img src="/img/user-78.gif" class="rounded-circle" style="width: 27px; height: 27px;" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-2">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/nft-5.gif" class="rounded-3" style="width: 50px; height: 50px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/img/user-80.png" style="width: 22px;" class="border border-1 box-shadow border-color-white rounded-circle" alt="user">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/nft-6.gif" class="rounded-3" style="width: 50px; height: 50px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/img/user-81.png" style="width: 22px;" class="border border-1 box-shadow border-color-white rounded-circle" alt="user">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/nft-7.png" class="rounded-3" style="width: 50px; height: 50px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/img/user-82.png" style="width: 22px;" class="border border-1 box-shadow border-color-white rounded-circle" alt="user">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/nft-8.png" class="rounded-3" style="width: 50px; height: 50px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/img/user-83.png" style="width: 22px;" class="border border-1 box-shadow border-color-white rounded-circle" alt="user">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/nft-9.png" class="rounded-3" style="width: 50px; height: 50px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/img/user-84.png" style="width: 22px;" class="border border-1 box-shadow border-color-white rounded-circle" alt="user">
                        ...
                        <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap mt-4">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination mb-0 justify-content-center">
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/nft" aria-label="Previous">
                                            <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                        </a>
                                    </li>
                                    <li class="page-item"><a class="page-link active" href="/dashboard/nft">1</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/nft">2</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/nft">3</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/nft">4</a></li>
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/nft" aria-label="Next">
            ...
            <div class="swiper nft-slide-two mb-4">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3 border-0 p-3 place-bid for-dark-card">
                            <a href="/dashboard/nft-details" class="d-block  mb-3 text-decoration-none position-relative">
                                <img src="/img/nft-10.png" class="rounded-3" alt="nft">
                                <span class="btn btn-primary py-2 px-3 d-inline-block fs-16 fw-medium position-absolute top-50 start-50 translate-middle opacity-0">
                                    Place Bid
                                </span>
                            </a>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3 border-0 p-3 place-bid for-dark-card">
                            <a href="/dashboard/nft-details" class="d-block mb-3 text-decoration-none position-relative">
                                <img src="/img/nft-11.png" class="rounded-3" alt="nft">
                                <span class="btn btn-primary py-2 px-3 d-inline-block fs-16 fw-medium position-absolute top-50 start-50 translate-middle opacity-0">
                                    Place Bid
                                </span>
                            </a>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3 border-0 p-3 place-bid for-dark-card">
                            <a href="/dashboard/nft-details" class="d-block  mb-3 text-decoration-none position-relative">
                                <img src="/img/nft-12.png" class="rounded-3" alt="nft">
                                <span class="btn btn-primary py-2 px-3 d-inline-block fs-16 fw-medium position-absolute top-50 start-50 translate-middle opacity-0">
                                    Place Bid
                                </span>
                            </a>
                            ...
                            <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                                <a href="/dashboard/creator-details" class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-85.png" class="rounded-circle" style="width: 27px; height: 27px;" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-81.png" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <h4 class="fs-14 fw-semibold mb-1">Christmas Eve</h4>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-80.png" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-82.png" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-83.png" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-84.png" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                    ...
                    <ul class="ps-0 mb-0 list-unstyled">
                        <li class="mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/img/united-states-3.png" style="width: 24px;" alt="united-states">
                                        <div class="ms-3">
                        ...
                        <li class="mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/img/japan.png" style="width: 24px;" alt="japan">
                                        <div class="ms-3">
                        ...
                        <li class="mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/img/australia-2.png" style="width: 24px;" alt="australia">
                                        <div class="ms-3">
                        ...
                        <li>
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/img/germany-2.png" style="width: 24px;" alt="germany">
                                        <div class="ms-3">
                    ...
                    <div class="swiper top-collections-slide">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="position-relative z-1">
                                    <a href="#" class="d-block position-relative">
                                        <img src="/img/collections.png" class="rounded-3" alt="collections">
                                        <img src="/img/collections.gif" class="rounded-3 position-absolute top-0 start-0 end-0 bottom-0" alt="collections">
                                    </a>
                                        ...
                                        <div class="rounded-3 p-3 d-flex justify-content-between align-items-center" style="background: rgba(35, 39, 46, 0.70); backdrop-filter: blur(6px);">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/img/user-76.gif" class="rounded-circle" style="width: 27px; height: 27px;" alt="user">
                                                    <img src="/img/verify-2.svg" style="width: 15px;" class="position-absolute top-100 start-100 translate-middle" alt="verify">
                                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="position-relative z-1">
                                    <a href="#" class="d-block position-relative">
                                        <img src="/img/collections-2.png" class="rounded-3" alt="collections">
                                    </a>
                                    <div class="position-absolute bottom-0 start-50 translate-middle-x w-100 p-2">
                                        <div class="rounded-3 p-3 d-flex justify-content-between align-items-center" style="background: rgba(35, 39, 46, 0.70); backdrop-filter: blur(6px);">
                                            <div class="d-flex align-items-center">
                            ...
                            <div class="swiper-slide">
                                <div class="position-relative z-1">
                                    <a href="#" class="d-block position-relative">
                                        <img src="/img/collections-3.png" class="rounded-3" alt="collections">
                                    </a>
                                    <div class="position-absolute bottom-0 start-50 translate-middle-x w-100 p-2">
                                        <div class="rounded-3 p-3 d-flex justify-content-between align-items-center" style="background: rgba(35, 39, 46, 0.70); backdrop-filter: blur(6px);">
                                            <div class="d-flex align-items-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/sellers-1.gif" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <h4 class="fs-14 fw-semibold mb-1">Christmas Eve</h4>
                                                    <span class="fs-12">Queensland</span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/sellers-2.gif" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/sellers-3.gif" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/sellers-4.gif" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/sellers-5.gif" class="rounded-circle" style="width: 40px; height: 40px;" alt="nft">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-86.png" class="rounded-circle" style="width: 32px; height: 32px;" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-87.png" class="rounded-circle" style="width: 32px; height: 32px;" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-88.png" class="rounded-circle" style="width: 32px; height: 32px;" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-89.png" class="rounded-circle" style="width: 32px; height: 32px;" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-90.png" class="rounded-circle" style="width: 32px; height: 32px;" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-60.jpg" class="rounded-circle" style="width: 32px; height: 32px;" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-61.jpg" class="rounded-circle" style="width: 32px; height: 32px;" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-62.jpg" class="rounded-circle" style="width: 32px; height: 32px;" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
