            ...
            <div class="card-group custom-shadow mb-4 rounded-3">
                    ...
                    <div class="card-body custom-padding-30 mx-xl-2">
                        <div class="d-flex align-items-center mb-5">
                            <div class="flex-shrink-0">
                                <img src="/img/total-students.svg" alt="total-students">
                            </div>
                        ...
                        <div class="d-flex align-items-center">
                            <i class="ri-arrow-right-up-line d-inline-block text-center rounded-1 fs-18 bg-success-80 text-success-50" style="width: 26px; height: 26px; line-height: 26px;"></i>
                ...
                <div class="card border-border-color bg-white">
                    <div class="card-body custom-padding-30 mx-xl-2">
                        <div class="d-flex align-items-center mb-5">
                            <div class="flex-shrink-0">
                                <img src="/img/total-teachers.svg" alt="total-students">
                            </div>
                            <div class="flex-grow-1 ms-md-3 ms-1">
                        ...
                        <div class="d-flex align-items-center">
                            <i class="ri-arrow-right-down-line d-inline-block text-center rounded-1 fs-18 text-danger-40 bg-danger-70" style="width: 26px; height: 26px; line-height: 26px;"></i>
                ...
                <div class="card border-border-color bg-white rounded-end-3">
                    <div class="card-body custom-padding-30 mx-xl-2">
                        <div class="d-flex align-items-center mb-5">
                            <div class="flex-shrink-0">
                                <img src="/img/attendance-today.svg" alt="attendance-today">
                            </div>
                            <div class="flex-grow-1 ms-md-3 ms-1">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-5">
            <div class="card custom-shadow rounded-3 bg-white border mb-4 custom-padding-30 pt-0 px-0">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 custom-padding-30 border-bottom custom-padding-30">
                    <h3 class="mb-0 fw-semibold">Teachers</h3>
                    <a href="/dashboard/instructors" class="text-decoration-none">
                        <span>View All</span>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle border-0">
                            <thead class="border-bottom">
                                <tr>
                                    <th scope="col" class="bg-transparent py-1 fw-normal fs-14">Name</th>
                                    <th scope="col" class="bg-transparent py-1 fw-normal fs-14 text-end">Subject</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/img/user-170.png" class="rounded-circle" alt="user">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/img/user-171.png" class="rounded-circle" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/img/user-172.png" class="rounded-circle" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/img/user-173.png" class="rounded-circle" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/img/user-174.png" class="rounded-circle" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                ...
                <div class="custom-padding-30">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 pb-4">
                        ...
                        <div class="dropdown select-dropdown without-border position-relative" style="right: -5px;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end bg-white border-0 box-shadow py-3" style="">
                                <li>
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <div class="d-flex ms-5">
                                <div class="text-center rounded-1" style="background-color: #FFE8D4; width: 42px; height: 42px; line-height: 42px;">
                                    <img src="/img/girls.svg" alt="boys">
                                </div>
                                <div class="ms-2">
        ...
        <div class="col-xxl-4 col-md-12">
            <div class="card custom-shadow rounded-3 bg-white border mb-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 custom-padding-30">
                    ...
                    <a href="/dashboard/notification" class="text-decoration-none">
                        <span>View All</span>
                        <i class="ri-arrow-right-s-line fs-18 position-relative top-1"></i>
                    </a>
                </div>
                ...
                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center border-bottom custom-padding-30 pt-0 pb-3 mb-3">
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                            <div class="text-center bg-primary-div rounded-circle" style="width: 40px; height: 40px; line-height: 40px;">
                                <img src="/img/notice-board-icon-1.svg" alt="notice-board-icon">
                            </div>
                        </div>
                    ...
                    <a href="/dashboard/school" class="rounded-circle d-inline-block text-center fs-18 hover-bg for-dark-read text-decoration-none border" style="width: 43px; height: 43px; line-height: 42px;">
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                            <div class="text-center bg-primary rounded-circle" style="width: 40px; height: 40px; line-height: 37px;">
                                <img src="/img/notice-board-icon-2.svg" alt="notice-board-icon">
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                            <div class="text-center bg-danger rounded-circle" style="width: 40px; height: 40px; line-height: 37px;">
                                <img src="/img/notice-board-icon-3.svg" alt="notice-board-icon">
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                            <div class="text-center bg-primary rounded-circle" style="width: 40px; height: 40px; line-height: 40px;">
                                <img src="/img/notice-board-icon-4.svg" alt="notice-board-icon">
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="table-responsive">
                <table class="table align-middle border-0" id="myTable">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <span class="fs-14 fw-medium">#101</span>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-175.png" class="rounded-circle" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                            ...
                            <td>
                                <span class="fs-14 fw-medium">Math</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">5A</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">(555) 123-4567</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">89% Overall (A)</span>
                            </td> 
                            <td>
                                <span class="badge bg-success-80 text-success-50 p-2 fs-12 fw-normal">Passed</span>
                            </td> 
                            <td>
                        ...
                        <tr>
                            <td>
                                <span class="fs-14 fw-medium">#102</span>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-176.png" class="rounded-circle" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                            ...
                            <td>
                                <span class="fs-14 fw-medium">English</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">8B</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">(555) 234-5678</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">32% Overall (F)</span>
                            </td> 
                            <td>
                                <span class="badge bg-danger-70 text-danger-60 p-2 fs-12 fw-normal">Fail</span>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                        ...
                        <tr>
                            <td>
                                <span class="fs-14 fw-medium">#103</span>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-177.png" class="rounded-circle" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                            ...
                            <td>
                                <span class="fs-14 fw-medium">Geography</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">4C</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">(555) 345-6789</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">92% Overall (A+)</span>
                            </td> 
                            <td>
                                <span class="badge bg-primary-70 text-primary-50 p-2 fs-12 fw-normal">Dropped</span>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                        ...
                        <tr>
                            <td>
                                <span class="fs-14 fw-medium">#104</span>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-178.png" class="rounded-circle" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                            ...
                            <td>
                                <span class="fs-14 fw-medium">Physics</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">6A</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">(555) 456-7890</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">85% Overall (B+)</span>
                            </td> 
                            <td>
                                <span class="badge bg-success-80 text-success-50 p-2 fs-12 fw-normal">Passed</span>
                            </td> 
                        ...
                        <tr>
                            <td>
                                <span class="fs-14 fw-medium">#105</span>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-179.png" class="rounded-circle" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                            ...
                            <td>
                                <span class="fs-14 fw-medium">History</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">7B</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">(555) 567-8901</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">25% Overall (F)</span>
                            </td> 
                            <td>
                                <span class="badge bg-danger-70 text-danger-60 p-2 fs-12 fw-normal">Fail</span>
                            </td> 
                        ...
                        <tr>
                            <td>
                                <span class="fs-14 fw-medium">#106</span>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-180.png" class="rounded-circle" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                            ...
                            <td>
                                <span class="fs-14 fw-medium">Biology</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">5B</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">(555) 678-9012</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">88% Overall (A)</span>
                            </td> 
                            <td>
                                <span class="badge bg-success-80 text-success-50 p-2 fs-12 fw-normal">Passed</span>
                            </td> 
                        ...
                        <tr>
                            <td>
                                <span class="fs-14 fw-medium">#107</span>
                            </td> 
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-181.png" class="rounded-circle" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                            ...
                            <td>
                                <span class="fs-14 fw-medium">Music</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">8A</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">(555) 789-0123</span>
                            </td> 
                            <td>
                                <span class="fs-14 fw-medium">93% Overall (A+)</span>
                            </td> 
                            <td>
                                <span class="badge bg-primary-70 text-primary-50 p-2 fs-12 fw-normal">Dropped</span>
                            </td> 
