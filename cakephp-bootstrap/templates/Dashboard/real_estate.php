                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5 mt-md-3 mt-xxl-0">
                                <div class="pt-sm-4 mt-sm-3 text-end">
                                    <img src="/img/real-property.png" style="width: 188px; height: 125px;" alt="real-property">
                                    <img src="/img/shape-9.png" class="position-absolute bottom-0 start-0" alt="shape">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                        <li>
                            <a href="/dashboard/my-profile">
                                <img src="/img/user-63.jpg" style="width: 40px; height: 40px;" class="rounded-circle border border-1 border-color-white" alt="user">
                            </a>
                        </li>
                        <li class="ms-m-15">
                            <a href="/dashboard/my-profile">
                                <img src="/img/user-64.jpg" style="width: 40px; height: 40px;" class="rounded-circle border border-1 border-color-white" alt="user">
                            </a>
                        </li>
                        <li class="ms-m-15">
                            <a href="/dashboard/my-profile">
                                <img src="/img/user-65.jpg" style="width: 40px; height: 40px;" class="rounded-circle border border-1 border-color-white" alt="user">
                            </a>
                        </li>
                        <li class="ms-m-15">
                            <a href="/dashboard/my-profile">
                                <img src="/img/user-66.jpg" style="width: 40px; height: 40px;" class="rounded-circle border border-1 border-color-white" alt="user">
                            </a>
                        </li>
                        <li class="ms-m-15">
                            <a href="/dashboard/user-list" class="rounded-circle d-block text-center text-decoration-none text-white fs-14 fw-bold border border-1 border-color-white" style="background-color: #FE7A36; width: 40px; height: 40px; line-height: 40px;">59</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <ul class="ps-0 mb-0 list-unstyled sales_by_locations mt-4">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="/img/portugal.svg" class="wh-30 rounded-circle" alt="portugal">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="/img/spain.svg" class="wh-30 rounded-circle" alt="spain">
                            </div>
                            <div class="flex-grow-1 ms-3">
                    ...
                    <div class="swiper recent-property-slide">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide bg-white p-2 rounded-3">
                                <img src="/img/property-5.png" class="rounded-3" alt="property">
                            ...
                            <div class="swiper-slide bg-white p-2 rounded-3">
                                <img src="/img/property-6.png" class="rounded-3" alt="property">
                    ...
                    <div class="card bg-white border-0 rounded-3 mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                <div class="flex-shrink-0">
                                    <img src="/img/property-1.png" class="rounded-3" style="width: 40px; height: 40px;" alt="property">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                <div class="flex-shrink-0">
                                    <img src="/img/property-2.png" class="rounded-3" style="width: 40px; height: 40px;" alt="property">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                <div class="flex-shrink-0">
                                    <img src="/img/property-3.png" class="rounded-3" style="width: 40px; height: 40px;" alt="property">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="/img/property-4.png" class="rounded-3" style="width: 40px; height: 40px;" alt="property">
                                </div>
                                <div class="flex-grow-1 ms-3">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-48.jpg" class="rounded-circle" style="width: 40px; height: 40px;" alt="user">
                                    </div>
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-49.jpg" class="rounded-circle" style="width: 40px; height: 40px;" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                                        <div class="d-flex flex-wrap gap-2 justify-content-between">
                                            <div>
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-50.jpg" class="rounded-circle" style="width: 40px; height: 40px;" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                                        <div class="d-flex flex-wrap gap-2 justify-content-between">
                                            <div>
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-51.jpg" class="rounded-circle" style="width: 40px; height: 40px;" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                                        <div class="d-flex flex-wrap gap-2 justify-content-between">
                                            <div>
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="flex-shrink-0">
                                        <img src="/img/user-52.jpg" class="rounded-circle" style="width: 40px; height: 40px;" alt="user">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                                        <div class="d-flex flex-wrap gap-2 justify-content-between">
                                            <div>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination mb-0 justify-content-center">
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/real-estate" aria-label="Previous">
                                            <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                        </a>
                                    </li>
                                    <li class="page-item"><a class="page-link active" href="/dashboard/real-estate">1</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/real-estate">2</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/real-estate">3</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/real-estate">4</a></li>
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/real-estate" aria-label="Next">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-1.jpg" class="wh-44 rounded-2" alt="user">
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-2.jpg" class="wh-44 rounded-2" alt="user">
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-3.jpg" class="wh-44 rounded-2" alt="user">
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-4.jpg" class="wh-44 rounded-2" alt="user">
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                        <img src="/img/user-5.jpg" class="wh-44 rounded-2" alt="user">
                                        <div class="ms-2">
