                ...
                <div class="card-body p-4">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <img src="/img/ads.gif" style="width: 60px;" alt="ads">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <img src="/img/video-advertising.gif" style="width: 60px;" alt="video-advertising">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <img src="/img/call-to-action.gif" style="width: 60px;" alt="call-to-action">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <img src="/img/banner.gif" style="width: 60px;" alt="banner">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="ps-0 mb-0 list-unstyled">
                        <li class="mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex">
                                        <img src="/img/facebook.svg" style="width: 31px;" alt="facebook">
                                        <div class="ms-3">
                        ...
                        <li class="mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex">
                                        <img src="/img/dribbble.svg" style="width: 31px;" alt="dribbble">
                                        <div class="ms-3">
                        ...
                        <li class="mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex">
                                        <img src="/img/instagram.svg" style="width: 31px;" alt="instagram">
                                        <div class="ms-3">
                        ...
                        <li class="mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex">
                                        <img src="/img/behance.svg" style="width: 31px;" alt="behance">
                                        <div class="ms-3">
                        ...
                        <li class="mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex">
                                        <img src="/img/figma.svg" style="width: 31px;" alt="figma">
                                        <div class="ms-3">
                        ...
                        <li>
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="flex-shrink-0">
                                    <div class="d-flex">
                                        <img src="/img/google2.svg" style="width: 31px;" alt="google">
                                        <div class="ms-3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-3 gap-xl-2 gap-xxl-3 flex-wrap">
                                                        <img src="/img/facebook4.svg" alt="facebook">
                                                        <img src="/img/instagram2.svg" alt="instagram">
                                                        <img src="/img/google3.svg" alt="facebook">
                                                        <img src="/img/linkedin2.svg" alt="facebook">
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                                        ...
                                                        <li class="ms-m-15">
                                                            <a href="/dashboard/users-list" class="wh-34 lh-34 rounded-circle d-block text-center text-decoration-none text-white fs-12 fw-medium border border-1 border-color-white" style="background-color: #3A4252;">+3</a>
                                                        </li>
                                                    </ul>
                                                </td>
                                                <td>
                                                    <a href="/dashboard/nft-details" class="rounded-circle d-inline-block text-center fs-18 hover-bg for-dark-read" style="background-color: #ECEEF2; width: 30px; height: 30px; line-height: 30px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                                        <li>
                                                            <a href="/dashboard/my-profile">
                                                                <img src="/img/user-25.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                            </a>
                                                        </li>
                                                        <li class="ms-m-15">
                                                            <a href="/dashboard/my-profile">
                                                                <img src="/img/user-26.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                            </a>
                                                        </li>
                                                        <li class="ms-m-15">
                                                            <a href="/dashboard/my-profile">
                                                                <img src="/img/user-27.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                                        ...
                                                        <li class="ms-m-15">
                                                            <a href="/dashboard/my-profile">
                                                                <img src="/img/user-28.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                                        <li>
                                                            <a href="/dashboard/my-profile">
                                                                <img src="/img/user-30.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                            </a>
                                                        </li>
                                                        <li class="ms-m-15">
                                                            <a href="/dashboard/my-profile">
                                                                <img src="/img/user-31.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                            </a>
                                                        </li>
                                                        <li class="ms-m-15">
                                                            <a href="/dashboard/my-profile">
                                                                <img src="/img/user-32.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </td>
                            ...
                            <ul class="ps-0 mb-0 list-unstyled">
                                <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <img src="/img/google3.svg" style="width: 18px;" alt="google3">
                                ...
                                <li class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <img src="/img/instagram2.svg" style="width: 18px;" alt="google3">
                                ...
                                <li class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <img src="/img/facebook4.svg" style="width: 18px;" alt="google3">
        ...
        <div class="col-lg-3 col-md-4">
            <div class="border-0 rounded-3 mb-4 text-center" style="background: linear-gradient(162deg, #D7B5FD 3.82%, #9947F5 98.54%);">
                <div class="card-body p-4 text-center">
                    ...
                    <div class="py-4 mb-3">
                        <img src="/img/marketing-tool.png" alt="marketing-tool">
                    </div>
                    <a href="/dashboard/contact" class="d-inline-block py-2 px-4 btn btn-primary border-0" style="background-color: #6A22A7;">
                        Contact Us
                    </a>
                </div>
            </div>
                ...
                <div class="tab-content-wrap">
                        ...
                        <form class="campaign-stepper-content m-auto" style="max-width: 625px;">
                            ...
                            <div class="mb-5">
                                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center border-bottom pb-4 mb-4">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/pdf.png" style="width: 35px;" alt="pdf">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center border-bottom pb-4 mb-4">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/doc.png" style="width: 35px;" alt="doc">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center border-bottom pb-4 mb-4">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/xl4.png" style="width: 35px;" alt="xl4">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center border-bottom pb-4 mb-4">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/jpg.png" style="width: 35px;" alt="pdf">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="tab-contents">
                        <div class="campaign-stepper-content m-auto text-center mb-5" style="max-width: 625px;">
                            <div class="mb-4">
                                <img src="/img/interface-welcome.png" alt="interface-welcome">
                            </div>
                    ...
                    <div class="tab-contents continue-none">
                        <div class="campaign-stepper-content">
                            <div class="d-flex align-items-center mb-4 mb-md-5">
                                <div class="flex-shrink-0">
                                    <img src="/img/christmas.png" alt="christmas">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                        ...
                                        <ul class="ps-0 mb-0 list-unstyled d-flex flex-wrap gap-3">
                                            <li>
                                                <button class="border-0 p-2 bg-body-bg d-flex align-items-center rounded-2">
                                                    <img src="/img/user-90.png" class="border border-white rounded-circle" alt="user">
                                                    <span class="fw-medium ms-2 text-secondary">Jonathon Ronan</span>
                                                </button>
                                            </li>
                                            <li>
                                                <button class="border-0 p-2 bg-body-bg d-flex align-items-center rounded-2">
                                                    <img src="/img/user-91.png" class="border border-white rounded-circle" alt="user">
