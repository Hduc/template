<div class="main-content-container overflow-hidden">
    <div class="card bg-white border-0 rounded-3 p-4 pb-0 mb-4">
        <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-4">
            <h3 class="fs-24 fw-normal mb-0">Welcome Back, <span class="text-primary">Olivia!</span> <img src="/img/dog.svg" alt="dog"></h3>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-end fw-medium ps-0">
                                                <div class="d-flex">
                                                    <img src="/img/usa.svg" class="rounded-circle" style="width: 20px;" alt="usa">
                                        ...
                                        <tr>
                                            <td class="text-end fw-medium ps-0">
                                                <div class="d-flex">
                                                    <img src="/img/germany.svg" class="rounded-circle" style="width: 20px;" alt="germany">
                                        ...
                                        <tr>
                                            <td class="text-end fw-medium ps-0">
                                                <div class="d-flex">
                                                    <img src="/img/united-kingdom.svg" class="rounded-circle" style="width: 20px;" alt="united-kingdom">
                                        ...
                                        <tr>
                                            <td class="text-end fw-medium ps-0">
                                                <div class="d-flex">
                                                    <img src="/img/canada.svg" class="rounded-circle" style="width: 20px;" alt="usa">
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-1.jpg" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-2.jpg" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-3.jpg" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-4.jpg" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dashboard/my-profile" class="d-flex align-items-center">
                                                <img src="/img/user-5.jpg" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
                        ...
                        <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination mb-0 justify-content-center">
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/sales" aria-label="Previous">
                                            <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                        </a>
                                    </li>
                                    <li class="page-item"><a class="page-link active" href="/dashboard/sales">1</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/sales">2</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/sales">3</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/sales">4</a></li>
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/sales" aria-label="Next">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card bg-primary-div bg-opacity-10 border-0 rounded-3 p-4 mb-4">
                <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                        <img src="/img/balance-2.png" alt="balance">
                    </div>
                    <div class="flex-grow-1 ms-2">
