                        ...
                        <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap p-4">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination mb-0 justify-content-center">
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/finance" aria-label="Previous">
                                            <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                        </a>
                                    </li>
                                    <li class="page-item"><a class="page-link active" href="/dashboard/finance">1</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/finance">2</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/finance">3</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/finance">4</a></li>
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/finance" aria-label="Next">
                ...
                <div class="card-body p-4 pb-0">
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-4">
                            <div class="bg-img p-4 rounded-3" style="background-image: url(/img/debit-card.png);">
                                <div class="d-flex align-content-center justify-content-between mb-4">
                                    <span class="text-white fs-12 fw-medium">Debit Card</span>
                                    <img src="/img/debit.svg" alt="debit">
                                </div>
                                <img class="mb-4" src="/img/board-1.png" alt="board">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="bg-img p-4 rounded-3" style="background-image: url(/img/virtual-card.png);">
                                <div class="d-flex align-content-center justify-content-between mb-4">
                                    <span class="text-white fs-12 fw-medium">Debit Card</span>
                                    <img src="/img/virtual.svg" alt="debit">
                                </div>
                                <img class="mb-4" src="/img/board-1.png" alt="board">
