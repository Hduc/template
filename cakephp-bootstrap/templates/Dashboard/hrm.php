    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="d-flex flex-wrap gap-2 justify-content-md-end mb-4">
                <a href="/dashboard/pricing-plan" class="btn d-flex align-items-center gap-1" style="background-color: #F3E8FF; color: #7C24CC; padding: 3.5px 11px;">
                    ...
                    <div class="d-flex align-items-center mb-4 pb-2">
                        <div class="flex-shrink-0">
                            <div class="text-center rounded-2 bg-primary-50" style="width: 44px; height: 44px; line-height: 44px;">
                                <img src="/img/icon-employees.svg" alt="icon-employees">
                            </div>
                        </div>
                    ...
                    <div class="d-flex align-items-center mb-4 pb-2">
                        <div class="flex-shrink-0">
                            <div class="text-center rounded-2 bg-danger-50" style="width: 44px; height: 44px; line-height: 44px;">
                                <img src="/img/icon-resigned.svg" alt="icon-resigned">
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex align-items-center mb-4 pb-2">
                        <div class="flex-shrink-0">
                            <div class="text-center rounded-2 bg-primary-div-50" style="width: 44px; height: 44px; line-height: 44px;">
                                <img src="/img/new-employees.svg" alt="new-employees">
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <span class="d-block mb-1">New Employees</span>
                            <h3 class="fw-semibold fs-20 mb-0">8,24</h3>
                        </div>
                    </div>
                ...
                <div class="custom-padding-30">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3" style="padding-bottom: 33px;">
                        ...
                        <div class="position-relative">
                            <input type="text" class="form-control bg-body-bg position-relative border" id="range_datepicker" style="width: 216px; height: 30px; padding-left: 35px;" placeholder="29/10/2024 - 28/11/2024"/>
                            <i class="ri-calendar-line position-absolute top-50 start-0 translate-middle-y ps-3 fs-15"></i>
                        </div>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 rounded-3 bg-white mb-4">
                ...
                <ul class="ps-0 list-unstyled mb-2">
                    <li class="d-flex justify-content-between align-items-center border-top" style="padding: 13px 30px;">
                    ...
                    <li class="d-flex justify-content-between align-items-center border-top" style="padding: 13px 30px;">
                        <div class="d-flex align-items-center" style="width: 175px;">
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-inline-block bg-success" style="width: 8px; height: 8px;"></span>
                    ...
                    <div class="d-flex align-items-center mb-4 mb-md-5">
                        <div class="flex-shrink-0">
                            <div class="bg-primary-50 bg-opacity-10 text-center rounded-1" style="width: 42px; height: 42px; line-height: 42px;">
                                <img src="/img/icon-total-payroll.svg" alt="icon-total-payroll">
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <div class="bg-success-60 bg-opacity-10 text-center rounded-1" style="width: 42px; height: 42px; line-height: 37px;">
                                    <img src="/img/icon-salary-paid.svg" alt="icon-salary-paid">
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center ms-sm-3">
                            <div class="flex-shrink-0">
                                <div class="bg-danger-50 bg-opacity-10 text-center rounded-1" style="width: 42px; height: 42px; line-height: 42px;">
                                    <img src="/img/icon-salary-pending.svg" alt="icon-salary-paid">
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-3">
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-0">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 custom-padding-30 border-bottom pb-4">
                        <h3 class="mb-0 fw-semibold">Employee Leave Request</h3>
                        <div class="dropdown select-dropdown">
                            <button class="dropdown-toggle bg-transparent border text-body rounded-2" style="padding-right: 35px;" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                This Month
                            </button>
                    ...
                    <div class="default-table-area style-three employee-leave-request">
                        <div class="table-responsive">
                            <table class="table align-middle border-0">
                                <thead class="border-bottom">
                                    <tr>
                                        <th scope="col" class="bg-transparent fw-normal">Employee</th>
                                        <th scope="col" class="bg-transparent fw-normal">Leave Type</th>
                                        <th scope="col" class="bg-transparent fw-normal">Days</th>
                                        <th scope="col" class="bg-transparent fw-normal">Status</th>
                                        <th scope="col" class="bg-transparent fw-normal">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-151.png" class="rounded-circle" alt="user">
                                                </div>
                                        ...
                                        <td class="fs-14 fw-medium">Vacation</td> 
                                        <td class="fs-14 fw-medium">3</td> 
                                        <td>
                                            <span class="badge bg-success-80 text-success-50 p-2 fs-12 fw-normal">Approved</span>
                                        </td> 
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                                                    <i class="material-symbols-outlined fs-18 text-primary-div-50">border_color</i>
                                                </button>
                                                <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-152.png" class="rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <td class="fs-14 fw-medium">Sick Leave</td> 
                                        <td class="fs-14 fw-medium">2</td> 
                                        <td>
                                            <span class="badge bg-primary-div-60 text-primary-div-50 p-2 fs-12 fw-normal">Pending</span>
                                        </td> 
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-153.png" class="rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <td class="fs-14 fw-medium">Maternity Leave</td> 
                                        <td class="fs-14 fw-medium">4</td> 
                                        <td>
                                            <span class="badge bg-danger-70 text-danger-60 p-2 fs-12 fw-normal">Rejected</span>
                                        </td> 
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-154.png" class="rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/img/user-155.png" class="rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                        ...
                                        <td class="fs-14 fw-medium">Personal Leave</td> 
                                        <td class="fs-14 fw-medium">1</td> 
                                        <td>
                                            <span class="badge bg-primary-div-60 text-primary-div-50 p-2 fs-12 fw-normal">Pending</span>
                                        </td> 
                                        <td>
                        ...
                        <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 custom-padding-30">
                            <span class="fs-12 fw-medium">Showing 5 of 30 Results</span>

                            <nav aria-label="Page navigation example">
                                <ul class="pagination mb-0 justify-content-center">
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/hrm" aria-label="Previous">
                                            <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                        </a>
                                    </li>
                                    <li class="page-item"><a class="page-link active" href="/dashboard/hrm">1</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/hrm">2</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/hrm">3</a></li>
                                    <li class="page-item"><a class="page-link" href="/dashboard/hrm">4</a></li>
                                    <li class="page-item">
                                        <a class="page-link icon" href="/dashboard/hrm" aria-label="Next">
                ...
                <div class="table-responsive">
                    <table class="table align-middle border-0" id="myTable">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP001</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-156.png" class="rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                ...
                                <td>
                                    <span class="fs-14 fw-medium">Marketing</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">Marketing Lead</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">Jan 15, 2020</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">$85,000</span>
                                </td> 
                                <td>
                                    <span class="badge bg-success-80 text-success-50 p-2 fs-12 fw-normal">Active</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                            ...
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP002</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-157.png" class="rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                ...
                                <td>
                                    <span class="fs-14 fw-medium">Human Resources</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">HR Manager</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">Mar 10, 2021</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">$75,000</span>
                                </td> 
                                <td>
                                    <span class="badge bg-primary-div-60 text-primary-div-50 p-2 fs-12 fw-normal">On Leave</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                            ...
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP003</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-158.png" class="rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                ...
                                <td>
                                    <span class="fs-14 fw-medium">Software Engineer</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">Feb 22, 2019</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">$95,000</span>
                                </td> 
                                <td>
                                    <span class="badge bg-success-80 text-success-50 p-2 fs-12 fw-normal">Active</span>
                                </td> 
                            ...
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP004</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-159.png" class="rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                ...
                                <td>
                                    <span class="fs-14 fw-medium">Sales</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">Sales Manager</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">Apr 12, 2022</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">$90,000</span>
                                </td> 
                                <td>
                                    <span class="badge bg-success-80 text-success-50 p-2 fs-12 fw-normal">Active</span>
                                </td> 
                            ...
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP005</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-160.png" class="rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                ...
                                <td>
                                    <span class="fs-14 fw-medium">Finance</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">Financial Analyst</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">Aug 05, 2020</span>
                                </td> 
                                <td>
                                    <span class="fs-14 fw-medium">$80,000</span>
                                </td> 
                                <td>
                                    <span class="badge bg-danger-70 text-danger-60 p-2 fs-12 fw-normal">Resigned</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                            ...
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP006</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                            ...
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP007</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                            ...
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP008</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                            ...
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP009</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                            ...
                            <tr>
                                <td>
                                    <span class="fs-14 fw-medium">EMP010</span>
                                </td> 
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
