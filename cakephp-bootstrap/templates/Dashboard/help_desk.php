...
<div class="col-lg-4">
    <div class="card bg-white border-0 rounded-3 mb-4 position-relative">
        <div class="card-body p-4">
            ...
            <p>Ticket Solved</p>
            <a href="/dashboard/my-profile" class="btn btn-primary fw-medium">View Profile</a>
        </div>
        <img src="/img/congratulations.gif" class="congratulations wh-150 position-absolute" alt="congratulations">
    </div>
            ...
            <div class="card bg-primary border-0 rounded-3 position-relative mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3 mb-lg-4">
                        ...
                        <select class="form-select month-select form-control p-0 h-auto border-0 w-90 text-white bg-transparent" style="background-position: right 0 center; background-image: url(/img/down-white.svg);" aria-label="Default select example">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <img src="/img/satisfaction.png" alt="satisfaction">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="/dashboard/instructors" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/img/user-29.jpg" class="wh-44 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-2">
